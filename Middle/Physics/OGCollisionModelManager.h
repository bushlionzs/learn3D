...
#ifndef __OGCollisionModelManager_H__
#define __OGCollisionModelManager_H__
...
namespace Orphigine
{
    ...
    public:
		...
		//dscky add 动态卸载的时候，这里保存了一个MeshPtr，必须通知卸载，添加函数/////
		bool   removeCacheItem(Ogre::Mesh* pMesh);
		//dscky add 动态卸载的时候，这里保存了一个MeshPtr，必须通知卸载，添加函数/////
...
#endif __OGCollisionModelManager_H__
