...
/*
 ...
 =======================================================================================================================
 */
int32 CMapRegion::GetIndex(const Ogre::Vector2*pfvPoint) const
{
...
/*
 ...
 =======================================================================================================================
 */
int32 CMapRegion::GetNeighborBulgeIndex(const Ogre::Vector2*pfvPoint, BOOL bCountSelf, BOOL bClockwise) const
{
...
/*
 ...
 =======================================================================================================================
 */
const Ogre::Vector2*CMapRegion::GetNeighborBulge(int32 nIndex, BOOL bCountSelf, BOOL bClockwise) const
{
...
/*
 ...
 =======================================================================================================================
 */
const Ogre::Vector2*CMapRegion::GetNeighborBulge(const Ogre::Vector2*pfvPoint, BOOL bCountSelf, BOOL bClockwise) const
{
	int32 nIndex = GetIndex(pfvPoint);
...
/*
 ...
 =======================================================================================================================
 */
const Ogre::Vector2*CMapRegion::GetPoint(int32 nIndex, BOOL bLoop) const
{
	if(m_vfPoints.empty())
	{
		return NULL;
...
/*
 ...
 =======================================================================================================================
 */
const Ogre::Vector2*CMapRegion::GetPoint(int32 nIndex) const
{
