...
public:
	...
	struct PathUnit
	{
		Ogre::Vector2 fvStart;				/* 起始点 */
		Ogre::Vector2 fvTarget;				/* 目标点 */
	};
...
public:
	...
	{
		Ogre::Vector2 fvRegionPos1;	/* 阻挡边顶点 */
		Ogre::Vector2 fvRegionPos2;
		Ogre::Vector2 fvCrossPos;		/* 交点 */
		Ogre::Vector2 fvVertexNormal; /* 阻挡边的法线 */
	};
...
protected:
	...
	BOOL GetRegionOffsetPos
		(
			const Ogre::Vector2&fvCurrPos,		/* 当前位置 */
			const Ogre::Vector2&fvCrossPos,	/* 于阻挡边的交点 */
			const Ogre::Vector2 fvRegionPos1,		/* 阻挡边顶点1 */
			const Ogre::Vector2 fvRegionPos2,		/* 阻挡边顶点2 */
			FLOAT fOffsetDist,				/* 偏移距离 */
			Ogre::Vector2&fvOutPos				/* 返回的偏移位置 */
		);
