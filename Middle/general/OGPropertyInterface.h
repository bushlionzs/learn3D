#ifndef __OGPropertyInterface_H__
#define __OGPropertyInterface_H__
...
namespace Orphigine
{
    ...
    */
    class _OrphigineExport PropertyInterface 
    {
    protected:
    ...
    public:
        ...
        */
        ...
        /** Cleans up the static 'msDictionary' required to reset Orphigine,
...
#endif __OGPropertyInterface_H__
