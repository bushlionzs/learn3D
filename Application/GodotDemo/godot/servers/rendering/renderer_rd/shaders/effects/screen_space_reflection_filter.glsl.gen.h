...
#ifndef SCREEN_SPACE_REFLECTION_FILTER_GLSL_GEN_H_RD
#define SCREEN_SPACE_REFLECTION_FILTER_GLSL_GEN_H_RD
...
void main() {
	...
	imageStore(dest_radius, ssC, vec4(accum_radius));
		...
		setup(nullptr, nullptr, _compute_code, "ScreenSpaceReflectionFilterShaderRD");
	}
};
