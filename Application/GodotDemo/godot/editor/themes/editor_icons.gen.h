...
#ifndef _EDITOR_ICONS_H
#define _EDITOR_ICONS_H
static const int editor_icons_count = 938;
static const char *editor_icons_sources[] = {
	...
	R"<!>(<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"><path fill="none" stroke="#e0e0e0" stroke-linejoin="round" stroke-width="2" d="M2 12c6 0 6 2 12 2V4C8 4 8 2 2 2z"/></svg>)<!>",
	R"<!>(<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"><path fill="#e0e0e0" d="M12 2a1 1 0 0 0 0 2 1 1 0 0 0 0-2zM6 5a5 5 0 0 0 0 10A5 5 0 0 0 6 5z"/></svg>)<!>",
...
static const char *editor_icons_names[] = {
	"2D",
	"3D",
	"AABB",
	"AcceptDialog",
...
static const int editor_md_thumbs_count = 3;
static const int editor_md_thumbs_indices[] = {246, 249, 260};


static const int editor_bg_thumbs_count = 5;
static const int editor_bg_thumbs_indices[] = {240, 242, 245, 257, 293};
#endif
