...
#ifndef RENDERING_DEVICE_DRIVER_NULL_H
#define RENDERING_DEVICE_DRIVER_NULL_H
...
public:
	RenderingDeviceDriverNULL(RenderingContextDriverNULL *p_context_driver);
	virtual ~RenderingDeviceDriverNULL();
