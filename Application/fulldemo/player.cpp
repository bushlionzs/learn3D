...
void Player::createCharRenderInterface(void)
{
	Character::createCharRenderInterface();
...
void Player::UpdateFaceMesh(void)
{
...
/*--------------------------------------------------
--------------------------------------------------*/
void Player::UpdateHairMesh(void)
{
...
int32 Player::GetFashionHead(BODY_PART_MODEL part)
{
