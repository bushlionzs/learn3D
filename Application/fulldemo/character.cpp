...
Ogre::Real Character::getDirection()
{
...
void Character::onAnimationEnd(const char* animName, const char* parentNodeType, const char* parentNodeName)
{
...
void Character::ChangeAction(int32_t nActionType, float fDegree, int32_t nActionID)
{
	//
...
LPCSTR Character::getCharActionNameByActionSetID(int32_t nActionSetID, int32_t nWeaponType, BOOL* pbHideWeapon, int32_t* pnAppointedWeaponID)
{
...
eWEAPON_TYPE Character::getMainWeaponType()
{
...
bool Character::setCharActionSlot(
	int32_t nAASNode,
	int32_t nActionID,
	bool bActionBySkill,
	FLOAT fRate,
...
bool Character::actorSetActionSlot
(
	LPCTSTR szSlotName,
...
bool Character::createSkillImpact(int32_t nActionID, float fDir)
{
...
void Character::setRaceId(int32_t raceId)
{
	if (mRaceId != raceId)
	{
		mRaceId = raceId;
...
void Character::setCharModelId(int32_t modelId)
{
...
void Character::setMountId(int32_t mountId)
{
...
void Character::OnChangeOfMountId()
{

}


void Character::UpdateModel_CharActionSet(void)
{
...
void Character::UpdateModel_MountActionSet(void)
{
