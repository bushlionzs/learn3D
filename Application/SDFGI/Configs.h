...
namespace Configs
{
    ...
    struct DDGIVolume
    {
        ...
        Ogre::Vector3  origin = { 0.f, 0.f, 0.f };
        Ogre::Vector3  eulerAngles = { 0.f, 0.f, 0.f };
        Ogre::Vector3  probeSpacing = { 0.f, 0.f, 0.f };

        Ogre::Vector3i    probeCounts = { 0, 0, 0 };
    ...
    struct Light
    {
        ...
        Ogre::Vector3 direction = { 0.f, 0.f, 0.f };
        Ogre::Vector3 color = { 1.f, 1.f, 1.f };
    ...
    struct Scene
    {
        ...
        Ogre::Vector3 skyColor = { 0.f, 0.f, 0.f };
