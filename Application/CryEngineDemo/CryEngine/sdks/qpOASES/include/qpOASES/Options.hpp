...
#ifndef CODE_BASE_FOLDER // Building dll outside of CE solution on Windows
    #define QPOASES_API __declspec(dllexport)
#else // Building dll or including inside CE solution
    #undef _HAS_EXCEPTIONS
    #define NOT_USE_CRY_MEMORY_MANAGER
    #include <CryCore/Platform/platform.h>
	
	#ifdef ORBIS
		#define QPO_IMP __declspec(dllimport)
		#define QPO_EXP __declspec(dllexport)
	#else
		#define QPO_IMP DLL_IMPORT
		#define QPO_EXP DLL_EXPORT
	#endif
	
    #if !defined(QPOASES_API)
		#if defined(qpOASES_EXPORTS)
			#define QPOASES_API QPO_EXP
		#else
			#define QPOASES_API QPO_IMP
		#endif
    #endif
#endif
