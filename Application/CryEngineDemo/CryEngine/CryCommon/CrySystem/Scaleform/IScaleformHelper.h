...
struct ISelectorModule : public Cry::IEnginePlugin
{
	CRYINTERFACE_DECLARE_GUID(ISelectorModule, "{E53F2127-B4BC-494E-B60A-42709BF5404A}"_cry_guid);

	virtual bool LoadScaleformImplementation(SSystemGlobalEnvironment& env, const SSystemInitParams& startupParams) = 0;
};
