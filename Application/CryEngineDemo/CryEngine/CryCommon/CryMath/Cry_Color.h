...
template<class T> struct Color_tpl
{
	...
	ILINE T&         operator[](int index)         { CRY_MATH_ASSERT(index >= 0 && index <= 3); return ((T*)this)[index]; }
	ILINE T          operator[](int index) const   { CRY_MATH_ASSERT(index >= 0 && index <= 3); return ((T*)this)[index]; }
