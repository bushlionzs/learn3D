...
STRUCT_VAR_INFO(m_ucViewDistRatio, TYPE_INFO(uint8))
...
STRUCT_VAR_INFO(m_collisionClassIdx, TYPE_INFO(int16))
STRUCT_VAR_INFO(m_flags, TYPE_INFO(uint16))
STRUCT_VAR_INFO(m_nMaterialId, TYPE_INFO(int32))
STRUCT_VAR_INFO(m_nMaterialLayers, TYPE_INFO(int32))
...
STRUCT_VAR_INFO(m_ucBright, TYPE_INFO(uint8))
STRUCT_VAR_INFO(m_ucAngle, TYPE_INFO(uint8))
...
STRUCT_VAR_INFO(m_ucBright, TYPE_INFO(uint8))
STRUCT_VAR_INFO(m_ucAngle, TYPE_INFO(uint8))
STRUCT_VAR_INFO(m_ucAngleX, TYPE_INFO(uint8))
STRUCT_VAR_INFO(m_ucAngleY, TYPE_INFO(uint8))
STRUCT_INFO_END(SVegetationChunk)

STRUCT_INFO_BEGIN(SMergedMeshChunk)
STRUCT_BASE_INFO(SRenderNodeChunk)
STRUCT_VAR_INFO(m_nGroups, TYPE_INFO(uint32))
...
STRUCT_VAR_INFO(m_depth, TYPE_INFO(uint8))
