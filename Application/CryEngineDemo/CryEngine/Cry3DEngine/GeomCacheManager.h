...
class CGeomCacheManager : public Cry3DEngineBase
{
public:
	CGeomCacheManager();
	~CGeomCacheManager();
...
private:
	...
	template<class TBufferHandleType> TBufferHandleType* NewBufferHandle(const uint32 size, SGeomCacheStreamInfo& streamInfo);
