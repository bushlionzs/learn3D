...
class CFlashUIElement
	: public IUIElement
	  ...
	  , public IExternalInterfaceHandler
...
public:
	...
	virtual void HandleExternalInterfaceCall(const char* pMethodName, const SFlashVarValue* pArgs, int numArgs, void* pUserData = 0, SFlashVarValue* pResult = 0);
	// ~IExternalInterfaceHandler
