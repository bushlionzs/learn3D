...
#ifndef __TexturePos2InterpolatorAffector_H__
#define __TexturePos2InterpolatorAffector_H__
...
namespace Ogre 
{
    class  Texture2PosInterpolatorAffector : public ParticleAffector
    {
    public:
        ...
        /** Default constructor. */
        Texture2PosInterpolatorAffector(ParticleSystem* psys);
