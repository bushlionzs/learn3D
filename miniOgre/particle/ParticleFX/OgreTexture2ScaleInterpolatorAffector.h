...
#ifndef __Texture2ScaleInterpolatorAffector_H__
#define __Texture2ScaleInterpolatorAffector_H__
...
namespace Ogre 
{
    class  Texture2ScaleInterpolatorAffector : public ParticleAffector
    {
    public:
        ...
        /** Default constructor. */
        Texture2ScaleInterpolatorAffector(ParticleSystem* psys);

        /** See ParticleAffector. */
        void _affectParticles(ParticleSystem* pSystem, Real timeElapsed);

		void setScaleAdjust(size_t index, const Ogre::Vector3& pos);
