...
#include <filament/CallbackHandler.h>
...
struct HwPipelineLayout : public HwBase {
...
public:
    ...
    virtual void purge() noexcept final;
...
protected:
    ...
    void debugCommandBegin(CommandStream* cmds, bool synchronous, const char* methodName) noexcept ;
    void debugCommandEnd(CommandStream* cmds, bool synchronous, const char* methodName) noexcept ;
