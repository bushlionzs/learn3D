...
#if !defined(NDEBUG)
std::stringstream& operator<<(std::stringstream& out, const filament::backend::TargetBufferInfo& tbi);
std::stringstream& operator<<(std::stringstream& out, const filament::backend::MRT& mrt);
#endif
