...
class InputManager :
    public OIS::KeyListener, public OIS::MouseListener, public Ogre::Singleton<InputManager>
{
public:
	InputManager();
...
private:
	...
	//InputCaptureType mInputCaptureType = IC_NONE;
...
#define INPUT_SYS_PTR InputManager::GetSingletonPtr()
