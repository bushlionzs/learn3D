...
void VulkanWindow::resize(unsigned int width, unsigned int height)
{
    ...
    mColorTarget = new Ogre::VulkanRenderTarget(mWidth, mHeight, true);
    mDepthTarget = (Ogre::VulkanRenderTarget*)rs->createRenderTarget("window_depth", width, height, Ogre::PF_DEPTH32_STENCIL8,
