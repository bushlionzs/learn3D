...
x418031_g_scriptId = 418031
x418031_g_ItemList = {}
x418031_g_LevelMin = 65	
--需要的等级
...
--事件交互入口
--**********************************
function x418031_ProcEventEntry( sceneId, selfId, bagIndex )
-- 不需要这个接口，但要保留空函数
end
...
--**********************************
function x418031_IsSkillLikeScript( sceneId, selfId)
	return 1; --这个脚本需要动作支持
end
...
--**********************************
function x418031_CancelImpacts( sceneId, selfId )
...
--**********************************
function x418031_OnConditionCheck( sceneId, selfId )
...
--**********************************
function x418031_OnDeplete( sceneId, selfId )
...
--注：这里是技能生效一次的入口
--**********************************
function x418031_OnActivateOnce( sceneId, selfId, impactId )
	
	if GetLevel(sceneId, selfId)< x418031_g_LevelMin then
...
--注：这里是技能生效一次的入口
--**********************************
function x418031_OnActivateEachTick( sceneId, selfId)
