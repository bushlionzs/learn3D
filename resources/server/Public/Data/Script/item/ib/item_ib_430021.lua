...
function x430021_OnActivateOnce( sceneId, selfId, impactId )
	...
	if bBindItem== 1 then
		AddBindItem( sceneId, 12030202,1 )	--江湖请柬1
		AddBindItem( sceneId, 12041101,14 )	--修行草14
		AddBindItem( sceneId, 11990011,1 )	--三番令1
		AddBindItem( sceneId, 12030200,1 )	--小喇叭1
		AddBindItem( sceneId, 12031012,1 )	--烟花1 偏偏年少
		AddBindItem( sceneId, 12031013,1 )	--烟花2 秋水伊人
		AddBindItem( sceneId, 12031019,1 )	--烟花3 斩
		AddBindItem( sceneId, 12031031,1 )	--烟花4 你猜我猜
	else
		AddItem( sceneId, 12030202,1 )	--江湖请柬1
		AddItem( sceneId, 12041101,14 )	--修行草14
		AddItem( sceneId, 11990011,1 )	--三番令1
		AddItem( sceneId, 12030200,1 )	--小喇叭1
		AddItem( sceneId, 12031012,1 )	--烟花1 偏偏年少
		AddItem( sceneId, 12031013,1 )	--烟花2 秋水伊人
		AddItem( sceneId, 12031019,1 )	--烟花3 斩
		AddItem( sceneId, 12031031,1 )	--烟花4 你猜我猜
	end
