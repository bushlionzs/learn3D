...
x430110_g_ItemTable         = {
                                ...
                                { name = "神传龙吟戒指（十字军）", itemid = 10288020 }, 
                                { name = "神传碎玉戒指（圣火使）", itemid = 10288024 }, 
                                { name = "神传逐日戒指（刺客）", itemid = 10288028 }, 
                                { name = "神传虎跃戒指（近卫军）", itemid = 10288032 }, 
                                { name = "神传白虎戒指（隐修士）", itemid = 10288036 }, 
                                { name = "神传师君戒指（僧侣）", itemid = 10288040 }, 
...
function x430110_ProcEventEntry( sceneId, selfId, targetId, scriptid, extid)
    BeginQuestEvent( sceneId)
        AddQuestText( sceneId, format( "\t您确认要选择#Y%s#W吗？\n\t您确认后将永久的获得，请谨慎挑选！", x430110_g_ItemTable[ extid].name) )
