...
x203718_g_Name	={}
x203718_g_ExtTarget={{type=20,n=1,target="找到@npc_126049学习并使用2级光明圣战技能"}}
x203718_g_MissionName="【新手】职业的进阶"
x203718_g_MissionInfo="\t你已经熟悉了生存的必要条件和王城周围的环境，现在你需要加强的就是你的自身实力了，王城的技能大师可以帮你快速地提升自身的能力。\n\t现在，你可以去找他了。"  --任务描述
x203718_g_MissionTarget=""		
x203718_g_MissionCompleted="\t我就是这里的技能大师，如果你愿意，我将是你终生的导师。\n\t活到老学到老，等你觉得自己杀敌变得缓慢的时候记得来找我学习新的技能。"					--完成任务npc说话的话
x203718_g_ContinueInfo="\t不清楚如何提升技能等级？在我这里就可以学习、提升火枪的技能。\n\t点击#G火枪技能学习#W按钮就能进入技能学习界面，里面#G明亮的技能#W表示你现在能掌握的技能，点击相应图标即可学习技能，当然你要有一定的经验和银子！\n\t最后记得学习完技能后，要将自己#G技能栏内技能的图标#W拖到下方#G快捷栏内#W，才能在需要的时候，方便快捷的使用。"
x203718_g_MissionHelp =	"#G您可以按下键盘上的#R2#G键，或者左键点击您下方技能快捷栏中的#R光明圣战#G技能。#W"
...
x203718_g_NpcGUID ={{ guid = 126049, name = "十字军技能大师"} } --人物回复人
--MisDescEnd
--**********************************
...
function x203718_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
	if IsQuestHaveDone(sceneId, selfId, x203718_g_MissionId) > 0 then
		return 
	end
...
function x203718_Msg2toplayer( sceneId, selfId,type)
		if type == 0 then
				Msg2Player(sceneId, selfId, "您接受了任务"..x203718_g_MissionName.."！", 0, 2)
		  	Msg2Player(sceneId, selfId, "您接受了任务"..x203718_g_MissionName.."！", 0, 3)
		elseif type == 1 then
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203718_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203718_g_MissionName.."！", 0, 3)
		elseif type == 2 then
				Msg2Player(sceneId, selfId, "您完成了任务"..x203718_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您完成了任务"..x203718_g_MissionName.."！", 0, 3)
				if x203718_g_ExpBonus > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G经验"..x203718_g_ExpBonus.."#cffcf00的奖励", 0, 2)
  			end
				if x203718_g_BonusMoney1 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G银卡"..x203718_g_BonusMoney1.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203718_g_BonusMoney2 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G现银"..x203718_g_BonusMoney2.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203718_g_BonusMoney3 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G金卡"..x203718_g_BonusMoney3.."文#cffcf00的奖励", 0, 2)
				end
				if x203718_g_BonusMoney4 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G朝廷声望值"..x203718_g_BonusMoney4.."#cffcf00的奖励", 0, 2)
				end
				if x203718_g_BonusMoney5 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G声望"..x203718_g_BonusMoney5.."#cffcf00的奖励", 0, 2)
				end
				if x203718_g_BonusMoney6 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G荣誉"..x203718_g_BonusMoney6.."#cffcf00的奖励", 0, 2)
				end
		end
end
