...
x203424_g_Name	={}
x203424_g_ExtTarget={{type=20,n=1,target="按下#GCTRL+1#W，做出马奶"}}
x203424_g_MissionName="【新手】新兵的补给"
x203424_g_MissionInfo="\t你的坐骑有个很不错的技能：马奶。\n\t对于我们这些常年在马背上生存的军人来说，马奶的作用无可替代，现在，试着做出一个马奶吧。"  --任务描述
x203424_g_MissionTarget="按下#GCTRL+1#W，做出马奶"		
x203424_g_MissionCompleted="\t清香的马奶，是补充体力的上品。你可以平时多做一些马奶以备不时之需。 "					--完成任务npc说话的话
x203424_g_ContinueInfo="\t清香的马奶，可是补充体力的上品。\n\t（按下#GCTRL+1#W，就能做出马奶。）"
...
function x203424_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
	if IsQuestHaveDone(sceneId, selfId, x203424_g_MissionId) > 0 then
		return 
	end
...
function x203424_Msg2toplayer( sceneId, selfId,type)
		if type == 0 then
				Msg2Player(sceneId, selfId, "您接受了任务"..x203424_g_MissionName.."！", 0, 2)
		  	Msg2Player(sceneId, selfId, "您接受了任务"..x203424_g_MissionName.."！", 0, 3)
		elseif type == 1 then
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203424_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203424_g_MissionName.."！", 0, 3)
		elseif type == 2 then
				Msg2Player(sceneId, selfId, "您完成了任务"..x203424_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您完成了任务"..x203424_g_MissionName.."！", 0, 3)
				if x203424_g_ExpBonus > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G经验"..x203424_g_ExpBonus.."#cffcf00的奖励", 0, 2)
  			end
				if x203424_g_BonusMoney1 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G银卡"..x203424_g_BonusMoney1.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203424_g_BonusMoney2 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G现银"..x203424_g_BonusMoney2.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203424_g_BonusMoney3 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G金卡"..x203424_g_BonusMoney3.."文#cffcf00的奖励", 0, 2)
				end
				if x203424_g_BonusMoney4 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G朝廷声望值"..x203424_g_BonusMoney4.."#cffcf00的奖励", 0, 2)
				end
				if x203424_g_BonusMoney5 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G声望"..x203424_g_BonusMoney5.."#cffcf00的奖励", 0, 2)
				end
				if x203424_g_BonusMoney6 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G荣誉"..x203424_g_BonusMoney6.."#cffcf00的奖励", 0, 2)
				end
		end
end
