...
x203431_g_Name	={}
x203431_g_ExtTarget={{type=20,n=1,target="找到@npc_131015"}}
x203431_g_MissionName="【新手】迟归的随从"
x203431_g_MissionInfo="\t我的随从木图，去了西北方收集马儿最爱吃的草料，到现在没有归来，莫非是他遇到了什么难事？\n\t你去西北方看看吧。"  --任务描述
x203431_g_MissionTarget="找到@npc_131015"		
x203431_g_MissionCompleted="\t你好，朋友。\n\t我的导师白鹿长老让你来的？"					--完成任务npc说话的话
...
x203431_g_BonusItem	=	{}
x203431_g_NpcGUID ={{ guid = 131015, name = "苍狼长老随从"} }
--MisDescEnd
--**********************************
...
function x203431_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
	if IsQuestHaveDone(sceneId, selfId, x203431_g_MissionId) > 0 then
		return 
	end
	if IsHaveQuest(sceneId,selfId, x203431_g_MissionId) > 0 then
...
function x203431_Msg2toplayer( sceneId, selfId,type)
		if type == 0 then
				Msg2Player(sceneId, selfId, "您接受了任务"..x203431_g_MissionName.."！", 0, 2)
		  	Msg2Player(sceneId, selfId, "您接受了任务"..x203431_g_MissionName.."！", 0, 3)
		elseif type == 1 then
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203431_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203431_g_MissionName.."！", 0, 3)
		elseif type == 2 then
				Msg2Player(sceneId, selfId, "您完成了任务"..x203431_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您完成了任务"..x203431_g_MissionName.."！", 0, 3)
				if x203431_g_ExpBonus > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G经验"..x203431_g_ExpBonus.."#cffcf00的奖励", 0, 2)
  			end
				if x203431_g_BonusMoney1 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G银卡"..x203431_g_BonusMoney1.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203431_g_BonusMoney2 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G现银"..x203431_g_BonusMoney2.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203431_g_BonusMoney3 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G金卡"..x203431_g_BonusMoney3.."文#cffcf00的奖励", 0, 2)
				end
				if x203431_g_BonusMoney4 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G朝廷声望值"..x203431_g_BonusMoney4.."#cffcf00的奖励", 0, 2)
				end
				if x203431_g_BonusMoney5 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G声望"..x203431_g_BonusMoney5.."#cffcf00的奖励", 0, 2)
				end
				if x203431_g_BonusMoney6 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G荣誉"..x203431_g_BonusMoney6.."#cffcf00的奖励", 0, 2)
				end
		end
end
