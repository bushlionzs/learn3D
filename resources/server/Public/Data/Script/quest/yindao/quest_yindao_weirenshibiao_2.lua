...
x203819_g_Name	={}
x203819_g_ExtTarget={{type=20,n=1,target="成功收取一个徒弟（提示：找到师徒管理员，点击#G“查找徒弟”#W）"}}
x203819_g_MissionName="【个人】为人师表"
x203819_g_MissionInfo="\t你现在的修为已经可以帮助新人了，努力学会当个师傅吧，这样也会加快你的晋升速度还可以得到你所需的威望值。\n\t点击#G“查找徒弟”#W，挑选你心仪的徒弟，然后点击#G“申请收徒”#W，这样就好了，不过要看你心仪的徒弟是不是愿意拜你为师了。"  --任务描述
x203819_g_MissionTarget=""		
x203819_g_MissionCompleted="\t恭喜你收到高徒，好好教授他吧，你也会受益非浅的。"					--完成任务npc说话的话
x203819_g_ContinueInfo="\t找到师徒管理员，点击#G“查找徒弟”#W，挑选你心仪的徒弟，然后点击#G“申请收徒”#W。"
...
x203819_g_NpcGUID ={{ guid = 129023, name = "拜答戈"} }
--MisDescEnd
--**********************************
-- 最大等级
...
function x203819_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
	if IsQuestHaveDone(sceneId, selfId, x203819_g_MissionId) > 0 then
		return 
	end
	if IsHaveQuest(sceneId,selfId, x203819_g_MissionId) > 0 then
...
function x203819_Msg2toplayer( sceneId, selfId,type)
		if type == 0 then
				Msg2Player(sceneId, selfId, "您接受了任务"..x203819_g_MissionName.."！", 0, 2)
		  	Msg2Player(sceneId, selfId, "您接受了任务"..x203819_g_MissionName.."！", 0, 3)
		elseif type == 1 then
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203819_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203819_g_MissionName.."！", 0, 3)
		elseif type == 2 then
				Msg2Player(sceneId, selfId, "您完成了任务"..x203819_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您完成了任务"..x203819_g_MissionName.."！", 0, 3)
				if x203819_g_ExpBonus > 0 then
					Msg2Player(sceneId, selfId, "#Y获得#R经验"..x203819_g_ExpBonus.."#Y的奖励", 0, 2)
  			end
				if x203819_g_BonusMoney1 > 0 then
	  		  Msg2Player(sceneId, selfId, "#Y获得#R银卡"..x203819_g_BonusMoney1.."文#Y的奖励", 0, 2)
	  		end
				if x203819_g_BonusMoney2 > 0 then
	  		  Msg2Player(sceneId, selfId, "#Y获得#R现银"..x203819_g_BonusMoney2.."文#Y的奖励", 0, 2)
	  		end
				if x203819_g_BonusMoney3 > 0 then
	  		  Msg2Player(sceneId, selfId, "#Y获得#R金卡"..x203819_g_BonusMoney3.."文#Y的奖励", 0, 2)
				end
				if x203819_g_BonusMoney4 > 0 then
					Msg2Player(sceneId, selfId, "#Y获得#R朝廷声望值"..x203819_g_BonusMoney4.."#Y的奖励", 0, 2)
				end
				if x203819_g_BonusMoney5 > 0 then
					Msg2Player(sceneId, selfId, "#Y获得#R声望"..x203819_g_BonusMoney5.."#Y的奖励", 0, 2)
				end
				if x203819_g_BonusMoney6 > 0 then
					Msg2Player(sceneId, selfId, "#Y获得#R荣誉"..x203819_g_BonusMoney6.."#Y的奖励", 0, 2)
				end
		end
end
