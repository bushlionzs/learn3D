...
x256299_g_NpcGUID ={{ guid = 140417, name = "包打听"} }
--MisDescEnd
--**********************************
-- 最大等级
...
function x256299_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
	if IsQuestHaveDone(sceneId, selfId, x256299_g_MissionId) > 0 then
		return 
	end
	if IsHaveQuest(sceneId,selfId, x256299_g_MissionId) > 0 then
...
function x256299_Msg2toplayer( sceneId, selfId,type)
		if type == 0 then
				Msg2Player(sceneId, selfId, "您接受了任务"..x256299_g_MissionName.."！", 0, 2)
		  	Msg2Player(sceneId, selfId, "您接受了任务"..x256299_g_MissionName.."！", 0, 3)
		elseif type == 1 then
				Msg2Player(sceneId, selfId, "您放弃了任务"..x256299_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您放弃了任务"..x256299_g_MissionName.."！", 0, 3)
		elseif type == 2 then
				Msg2Player(sceneId, selfId, "您完成了任务"..x256299_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您完成了任务"..x256299_g_MissionName.."！", 0, 3)
				if x256299_g_ExpBonus > 0 then
					Msg2Player(sceneId, selfId, "#Y获得#R经验"..x256299_g_ExpBonus.."#Y的奖励", 0, 2)
  			end
				if x256299_g_BonusMoney1 > 0 then
	  		  Msg2Player(sceneId, selfId, "#Y获得#R银卡"..x256299_g_BonusMoney1.."文#Y的奖励", 0, 2)
	  		end
				if x256299_g_BonusMoney2 > 0 then
	  		  Msg2Player(sceneId, selfId, "#Y获得#R现银"..x256299_g_BonusMoney2.."文#Y的奖励", 0, 2)
	  		end
				if x256299_g_BonusMoney3 > 0 then
	  		  Msg2Player(sceneId, selfId, "#Y获得#R金卡"..x256299_g_BonusMoney3.."文#Y的奖励", 0, 2)
				end
				if x256299_g_BonusMoney4 > 0 then
					Msg2Player(sceneId, selfId, "#Y获得#R朝廷声望值"..x256299_g_BonusMoney4.."#Y的奖励", 0, 2)
				end
				if x256299_g_BonusMoney5 > 0 then
					Msg2Player(sceneId, selfId, "#Y获得#R声望"..x256299_g_BonusMoney5.."#Y的奖励", 0, 2)
				end
				if x256299_g_BonusMoney6 > 0 then
					Msg2Player(sceneId, selfId, "#Y获得#R荣誉"..x256299_g_BonusMoney6.."#Y的奖励", 0, 2)
				end
		end
end
