...
x256012_g_ask ={"回到边塞","确定"}
x256012_g_answer ={"\t生死有命，灾祸常生，所以，你也不必太过沮丧。\n\t你要离开这里，返回边塞吗？"}

function x256012_ProcEventEntry(sceneId, selfId, NPCId, MissionId,which)	--点击该任务后执行此脚本
              ...
              elseif 	country == 2 then 
            	...
            	elseif 	country == 3 then 
            		NewWorld( sceneId, selfId, selfcountry * 100 + 51, 131.5 + random( 0, 5), 183.5 + random( 0, 5), 256012)
           			...
           			BeginQuestEvent(sceneId)
            		AddQuestText(sceneId,"\t很抱歉，你没有开通#G边塞玉门关传送#W，我不能将你送到那里。")
            		EndQuestEvent()	
            		DispatchQuestEventList(sceneId, selfId, NPCId)
