...
x270012_g_ExtTarget={{type=20,n=1,target="到@npc_141226处使用@itemid_13020324之后按照道士的指示去做完成仪式"}}
			...
			if GetQuestParam(sceneId,selfId,misIndex,0) == 0 then
				if x270012_g_doing==0   then
						...
						if x270012_g_PROTECTINFO.ScneneTimerIndex >= 0 then
								x270012_g_doing = 1
								x270012_g_daotong=CreateMonster(sceneId, 1619,195,45,3,1,-1,-1,20,98000,0,"巫山道人")
		...
		elseif which == 1 then
				if x270012_g_doing == 5   then
					if IsObjValid (sceneId,x270012_g_daotong) == 1 then
						SetPatrolId(sceneId, x270012_g_daotong, 5)
					end
					if IsObjValid (sceneId,x270012_g_taotie) == 1 then
						SetPatrolId(sceneId, x270012_g_taotie, 4)
					end
					if IsObjValid (sceneId,x270012_g_daotong) == 1 then
						NpcTalk(sceneId, x270012_g_daotong, "好的，我们继续！", -1)
					end
						CreateMonster(sceneId, 1622,185, 60,3,1,-1,-1,20,8000,0," ")
						x270012_g_PROTECTINFO.StartTime2 = GetCurrentTime()
						x270012_g_doing2= 0
    				return 1
    		elseif x270012_g_doing == 6   then
    			if IsObjValid (sceneId,x270012_g_daotong) == 1 then
						SetPatrolId(sceneId, x270012_g_daotong, 6)
						NpcTalk(sceneId, x270012_g_daotong, "好的，我们继续！", -1)
					end
					if IsObjValid (sceneId,x270012_g_taotie) == 1 then
						SetPatrolId(sceneId, x270012_g_taotie, 5)
					end
						CreateMonster(sceneId, 1622,180, 65,3,1,-1,-1,20,8000,0," ")
						x270012_g_PROTECTINFO.StartTime2 = GetCurrentTime()
						x270012_g_doing2= 0
    				return 1
    		elseif x270012_g_doing == 7   then
    			if IsObjValid (sceneId,x270012_g_daotong) == 1 then
						SetPatrolId(sceneId, x270012_g_daotong, 7)
						NpcTalk(sceneId, x270012_g_daotong, "好的，我们继续！", -1)
					end
					if IsObjValid (sceneId,x270012_g_taotie) == 1 then
						SetPatrolId(sceneId, x270012_g_taotie, 6)
					end
						CreateMonster(sceneId, 1622,172, 75,3,1,-1,-1,20,8000,0," ")
						x270012_g_PROTECTINFO.StartTime2 = GetCurrentTime()
						x270012_g_doing2= 0
    				return 1
    		elseif x270012_g_doing == 8   then
    			if IsObjValid (sceneId,x270012_g_daotong) == 1 then
						SetPatrolId(sceneId, x270012_g_daotong, 8)
						NpcTalk(sceneId, x270012_g_daotong, "好了等它来就好了！", -1)
					end
					if IsObjValid (sceneId,x270012_g_taotie) == 1 then
						SetPatrolId(sceneId, x270012_g_taotie, 7)
					end
						CreateMonster(sceneId, 1622,170, 90,3,1,-1,-1,20,8000,0," ")
						x270012_g_PROTECTINFO.StartTime2 = GetCurrentTime()
						x270012_g_doing2= 0
    				return 1
    		end
	...
	elseif x270012_g_doing == 2   then
			if GetCurrentTime() - x270012_g_PROTECTINFO.StartTime >= 5   then
				if IsObjValid (sceneId,x270012_g_daotong) == 1 then
						...
						SetPatrolId(sceneId, x270012_g_daotong, 4)
				end
        x270012_g_doing =3
			end
	elseif x270012_g_doing == 3   then
			if GetCurrentTime() - x270012_g_PROTECTINFO.StartTime >= 6   then
						x270012_g_taotie=CreateMonster(sceneId, 1620,193,50,3,1,-1,-1,20,96000,0,"饕餮")
						x270012_g_PROTECTINFO.StartTime2 = GetCurrentTime()
        x270012_g_doing =4
			end
	...
	if x270012_g_doing2== 0 then
		if GetCurrentTime() - x270012_g_PROTECTINFO.StartTime2 >= 8   then
			if x270012_g_doing == 4   then
						ItemBoxEnterScene(185, 60, 16, sceneId, 0, 13020324,90000)
						if IsObjValid (sceneId,x270012_g_daotong) == 1 then
      ...
      elseif x270012_g_doing == 5   then
						ItemBoxEnterScene(180, 65, 16, sceneId, 0, 13020324,80000)
						if IsObjValid (sceneId,x270012_g_daotong) == 1 then
								NpcTalk(sceneId, x270012_g_daotong, "快来把水玉涂在上面！", -1)
						end
						if IsObjValid (sceneId,x270012_g_taotie) == 1 then
        		...
        		x270012_g_doing2= 1
     elseif x270012_g_doing == 6   then
						ItemBoxEnterScene(172, 75, 16, sceneId, 0, 13020324,70000)
						if IsObjValid (sceneId,x270012_g_daotong) == 1 then
								NpcTalk(sceneId, x270012_g_daotong, "快来把水玉涂在上面！", -1)
						end
						if IsObjValid (sceneId,x270012_g_taotie) == 1 then
        		...
        		x270012_g_doing2= 1
     elseif x270012_g_doing == 7   then
						ItemBoxEnterScene(170, 90, 16, sceneId, 0, 13020324,60000)
						if IsObjValid (sceneId,x270012_g_daotong) == 1 then
								NpcTalk(sceneId, x270012_g_daotong, "快来把水玉涂在上面！", -1)
						end
						if IsObjValid (sceneId,x270012_g_taotie) == 1 then
