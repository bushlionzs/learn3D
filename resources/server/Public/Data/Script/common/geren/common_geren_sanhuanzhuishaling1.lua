...
x270351_g_ScriptId 					= 270351                  --脚本ID
x270351_g_MissionId 				= 1391                    --任务ID

x270351_g_MissionKind 				= 1                       --任务类型
x270351_g_LevelLess					= 20                      --场景开放等级  <=0 表示不限制

x270351_g_MissionName				= "【个人】三环任务(通缉令)"                --任务名称(512)
x270351_g_MissionTarget				= "  到%s消灭%s(%d/1)"          --任务目标
x270351_g_MissionInfo				= "\t杀死@npc_72004的@npc_72005,找到@npc_137600"            --任务信息
x270351_g_ContinueInfo				= "\t除掉那些野兽了么？"  --任务继续信息
x270351_g_MissionCompleted			= "\t这么快就回来了？真是不错！\n\t不过，我还是建议你组织一支3人以上的队伍，在我这里挑战#G三环任务#W或#G三环任务（三番令）#W，获得更丰厚的奖励！"  --任务完成信息
x270351_g_MissionCompleted1			= "\t你选择了使用悬赏令完成任务，你将会获得#G5倍#W的奖励，同时消耗#G5环#W任务次数！"  --任务完成信息
x270351_g_MissionHelp				= ""   --任务提示信息
...
--奖励
x270351_g_ExpBonus					= { 90, 117, 162 , 297 }                    	--奖励：经验 （数值填0，字符串为空，表示没有该项奖励）
x270351_g_BonusItem					= {}	--奖励：物品

x270351_g_BonusMoney1               = 0    --任务奖励绑定银币
x270351_g_BonusMoney2               = 0   --任务现银奖励系数
x270351_g_BonusMoney3               = 0    --任务奖励绑定金币
x270351_g_BonusMoney4               = 0  --任务奖励朝廷声望
x270351_g_BonusMoney5               = 0  --任务奖励江湖声望
x270351_g_BonusMoney6               = 0  --任务奖励荣誉
...
--任务目标顺序
x270351_MP_TARGET1					= 1         -- 要杀怪1
x270351_MP_TARGET2					= 2         -- 要杀怪2
x270351_MP_TARGET3					= 3         -- 要杀怪3
x270351_MP_TARGET4					= 4         -- 
x270351_MP_TARGET5					= 5         -- 
x270351_MP_TARGET6					= 6         -- 
x270351_MP_COMPLETE                 = 7         -- 玩家接任务时的等级
x270351_MP_ISCOMPLETE				= 0	        -- 代表完成 0未完成， 1完成

-- 接受任务提示
x270351_g_strAcceptMission          = "您接受了任务：【个人】三环任务(通缉令)"
-- 放弃任务提示
x270351_g_strAbandonMission         = "您放弃了任务：【个人】三环任务(通缉令)"
-- 完成任务提示
x270351_g_strFinishMission          = "您完成了任务：【个人】三环任务(通缉令)"
...
x270351_SubmitNPCGUID				= 126040	--交任务NPC GUID

-- 任务描述
x270351_g_MissionDescription        = "\t#Y@myname#W，见到你太好了，我正有事要找你呢！\n\t最近，有许多怪物从三环副本中逃了出来，四处作恶，闹得整个王国人心惶惶的。你是否愿意帮我们除去这些怪物？\n（每次接取本任务需要消耗一个#G通缉令#W，#G通缉令#W可在王城贸易区杂货商人处购买。）\n \n#G小提示：\n等级相当（相差5级以内）的玩家一起组队领取本任务，任务目标相同。#W"
-- 任务攻略
x270351_g_MissionBook               = "组队进行任务可以极大的提高完成任务的速度"
-- 任务继续信息
x270351_g_MissionContinue           = "\t你还没杀掉那只怪物吗？"
-- 任务目标之一描述
x270351_g_strMissionTarget          = "  使用背包中的@item_13810160#W搜寻并消灭在%s的#G%s#W(%d/1)"
-- 
x270351_g_ItemID                    = 11990016
x270351_g_AcceptItemID              = 11990017		--消耗
x270351_g_SubmitItemID              = 13810160--11990018		--领取任务后添加
-- 
x270351_g_MonsterTable              = {
                                        { minLevel = 20, maxLevel = 29, monList = { { id = 3840, objid = 400040, mapid = 158, name = "角木熊星", 	 Place = "西北方" , posName = "@npc_4000401"  }, { id = 3841, objid = 400041, mapid = 158, name = "奎木狼星",   Place = "东北方" , posName = "@npc_4000411"  }, { id = 3842, objid = 400042, mapid = 158, name = "毕月乌星",   Place = "西南方" , posName = "@npc_4000421"  }, { id = 3843, objid = 400043, mapid = 158, name = "翼火蛇星",   		Place = "东南方" , posName = "@npc_4000431"  }, { id = 3844, objid = 400044, mapid = 158, name = "胃土彘星", Place = "南方" ,posName = "@npc_4000441"  }, { id = 3845, objid = 400045, mapid = 158, name = "女土蝠星", Place = "南方" ,posName = "@npc_4000451" } }},  
                                        { minLevel = 30, maxLevel = 34, monList = { { id = 3846, objid = 400046, mapid = 204, name = "鬼金羊星", 	 Place = "东南方" , posName = "@npc_4000461"  }, { id = 3847, objid = 400047, mapid = 204, name = "尾火虎星",   Place = "西方" ,   posName = "@npc_4000471"  }, { id = 3849, objid = 400049, mapid = 204, name = "龙堡守卫",   Place = "东北方" , posName = "@npc_4000491"  }, { id = 3850, objid = 400050, mapid = 204, name = "蓝虺", 					Place = "西北方" , posName = "@npc_4000501"  } }},
                                        { minLevel = 35, maxLevel = 39, monList = { { id = 3849, objid = 400049, mapid = 204, name = "龙堡守卫", 	 Place = "东北方" ,	posName = "@npc_4000491"  }, { id = 3850, objid = 400050, mapid = 204, name = "蓝虺", 			Place = "西北方" , posName = "@npc_4000501"  }, { id = 3852, objid = 400052, mapid = 205, name = "长爪翼龙",   Place = "南方" ,   posName = "@npc_4000521"  }, { id = 3853, objid = 400053, mapid = 205, name = "厌火异兽",   		Place = "西北方" , posName = "@npc_4000531"  } }}, 
                                        { minLevel = 40, maxLevel = 44, monList = { { id = 3852, objid = 400052, mapid = 205, name = "长爪翼龙", 	 Place = "南方" ,		posName = "@npc_4000521"  }, { id = 3853, objid = 400053, mapid = 205, name = "厌火异兽",   Place = "西北方" , posName = "@npc_4000531"  }, { id = 3854, objid = 400054, mapid = 205, name = "探宝矿工",   Place = "北方" ,   posName = "@npc_4000541"  }, { id = 3856, objid = 400056, mapid = 205, name = "地穴恶魔",   		Place = "东方" ,   posName = "@npc_4000561"  } }}, 
                                        { minLevel = 45, maxLevel = 49, monList = { { id = 3854, objid = 400054, mapid = 205, name = "探宝矿工", 	 Place = "北方" ,		posName = "@npc_4000541"  }, { id = 3856, objid = 400056, mapid = 205, name = "地穴恶魔",   Place = "东方" ,	 posName = "@npc_4000561"  }, { id = 3858, objid = 400058, mapid = 206, name = "国王子民",   Place = "中部" ,   posName = "@npc_4000581"  }, { id = 3859, objid = 400059, mapid = 206, name = "狼人布鲁斯", 		Place = "东方" ,   posName = "@npc_4000591"  } }}, 
                                        { minLevel = 50, maxLevel = 54, monList = { { id = 3858, objid = 400058, mapid = 206, name = "国王子民", 	 Place = "中部" ,		posName = "@npc_4000581"  }, { id = 3859, objid = 400059, mapid = 206, name = "狼人布鲁斯", Place = "东方" ,	 posName = "@npc_4000591"  }, { id = 3862, objid = 400062, mapid = 206, name = "血蝙蝠",     Place = "北方" ,   posName = "@npc_4000621"  }, { id = 3863, objid = 400063, mapid = 206, name = "死亡骑士",   		Place = "东北方" , posName = "@npc_4000631"  } }}, 
                                        { minLevel = 55, maxLevel = 59, monList = { { id = 3862, objid = 400062, mapid = 206, name = "血蝙蝠", 		 Place = "北方" ,		posName = "@npc_4000621"  }, { id = 3863, objid = 400063, mapid = 206, name = "死亡骑士",   Place = "东北方" , posName = "@npc_4000631"  }, { id = 3864, objid = 400064, mapid = 207, name = "喷毒红蛛",   Place = "东南方" , posName = "@npc_4000641"  }, { id = 3866, objid = 400066, mapid = 207, name = "巨钳毒蝎",   		Place = "东北方" , posName = "@npc_4000661"  } }}, 
                                        { minLevel = 60, maxLevel = 64, monList = { { id = 3864, objid = 400064, mapid = 207, name = "喷毒红蛛",   Place = "东南方" , posName = "@npc_4000641"  }, { id = 3866, objid = 400066, mapid = 207, name = "巨钳毒蝎",   Place = "东北方" , posName = "@npc_4000661"  }, { id = 3868, objid = 400068, mapid = 207, name = "祝家庄护院", Place = "西方" ,   posName = "@npc_4000681"  }, { id = 3869, objid = 400069, mapid = 207, name = "祝家庄乡勇", 		Place = "东北方" , posName = "@npc_4000691"  } }},                               
 																				{ minLevel = 65, maxLevel = 69, monList = { { id = 3868, objid = 400068, mapid = 207, name = "祝家庄护院", Place = "西方" ,		posName = "@npc_4000681"	}, { id = 3869, objid = 400069, mapid = 207, name = "祝家庄乡勇", Place = "东北方" , posName = "@npc_4000691"  }, { id = 3870, objid = 400070, mapid = 208, name = "冰之灵", 		 Place = "中部" ,		posName = "@npc_4000701"  }, { id = 3871, objid = 400071, mapid = 208, name = "炎之灵", 				Place = "东方" ,	 posName = "@npc_4000711"  } }}, 
                                        { minLevel = 70, maxLevel = 74, monList = { { id = 3870, objid = 400070, mapid = 208, name = "冰之灵",     Place = "中部" ,		posName = "@npc_4000701"  }, { id = 3871, objid = 400071, mapid = 208, name = "炎之灵", 		Place = "东方" ,	 posName = "@npc_4000711"  }, { id = 3872, objid = 400072, mapid = 208, name = "地之灵", 		 Place = "北方" ,		posName = "@npc_4000721"  }, { id = 3873, objid = 400073, mapid = 208, name = "突厥蛮卫",   		Place = "东南方" , posName = "@npc_4000731"  } }}, 
                                        { minLevel = 75, maxLevel = 79, monList = { { id = 3872, objid = 400072, mapid = 208, name = "地之灵",     Place = "北方" ,		posName = "@npc_4000721"  }, { id = 3873, objid = 400073, mapid = 208, name = "突厥蛮卫", 	Place = "东南方" , posName = "@npc_4000731"  }, { id = 3874, objid = 400074, mapid = 209, name = "聚之灵", 		 Place = "西南方" , posName = "@npc_4000741"  }, { id = 3875, objid = 400075, mapid = 209, name = "突厥禁军", 			Place = "西方" ,   posName = "@npc_4000751"  } }}, 
                                        { minLevel = 80, maxLevel = 84, monList = { { id = 3874, objid = 400074, mapid = 209, name = "聚之灵",     Place = "西南方" , posName = "@npc_4000741"  }, { id = 3875, objid = 400075, mapid = 209, name = "突厥禁军", 	Place = "西方" ,   posName = "@npc_4000751"  }, { id = 3876, objid = 400076, mapid = 209, name = "扈家庄庄丁", Place = "北方" ,		posName = "@npc_4000761"  }, { id = 3877, objid = 400077, mapid = 209, name = "祝家庄庄丁", 		Place = "东方" ,	 posName = "@npc_4000771"  } }}, 
                                        { minLevel = 85, maxLevel = 89, monList = { { id = 3876, objid = 400076, mapid = 209, name = "扈家庄庄丁", Place = "北方" ,		posName = "@npc_4000761"  }, { id = 3877, objid = 400077, mapid = 209, name = "祝家庄庄丁", Place = "东方" ,	 posName = "@npc_4000771"  }, { id = 3878, objid = 400078, mapid = 210, name = "县衙官兵",   Place = "西北方" ,	posName = "@npc_4000781"  }, { id = 3879, objid = 400079, mapid = 210, name = "突厥蛮兵",   		Place = "东方" ,	 posName = "@npc_4000791"  } }}, 
                                        { minLevel = 90, maxLevel = 94, monList = { { id = 3878, objid = 400078, mapid = 210, name = "县衙官兵",   Place = "西北方" ,	posName = "@npc_4000781"  }, { id = 3879, objid = 400079, mapid = 210, name = "突厥蛮兵", 	Place = "东方" ,	 posName = "@npc_4000791"  }, { id = 3880, objid = 400080, mapid = 210, name = "灰壳蟹", 		 Place = "西南方" ,	posName = "@npc_4000801"  }, { id = 3881, objid = 400081, mapid = 210, name = "金国怯薛军", 		Place = "东方" ,   posName = "@npc_4000811"  } }}, 
                                        { minLevel = 95, maxLevel = 99, monList = { { id = 3880, objid = 400080, mapid = 210, name = "灰壳蟹",     Place = "西南北方",posName = "@npc_4000801"  }, { id = 3881, objid = 400081, mapid = 210, name = "金国怯薛军", Place = "东方" ,   posName = "@npc_4000811"  },	{ id = 3882, objid = 400082, mapid = 211, name = "金国质子军", Place = "东南方" , posName = "@npc_4000821"  }, { id = 3883, objid = 400083, mapid = 211, name = "随军巫师",   		Place = "东北方" , posName = "@npc_4000831"  } }}, 
                                        { minLevel = 100,maxLevel =160, monList = { { id = 3882, objid = 400082, mapid = 211, name = "金国质子军", Place = "东南方" , posName = "@npc_4000821"  }, { id = 3883, objid = 400083, mapid = 211, name = "随军巫师", 	Place = "东北方" , posName = "@npc_4000831"  }, { id = 3884, objid = 400084, mapid = 211, name = "神机营精锐", Place = "西方" ,		posName = "@npc_4000841"  }, { id = 3885, objid = 400085, mapid = 211, name = "金国乌月营斥候", Place = "东北方" , posName = "@npc_4000851"  } }},
...
--任务入口函数
--**********************************
function x270351_ProcEventEntry(sceneId, selfId, NPCId, MissionId, nExtIdx)	--点击该任务后执行此脚本
	...
	if( bHaveMission > 0) then
		...
		if(bDone > 0) then
			if nExtIdx ~= -1 then
				x270351_DispatchCompletedInfo( sceneId, selfId, NPCId, nExtIdx) --完成任务显示
			end
		else
			if nExtIdx ~= -1 then
				x270351_DispatchContinueInfo( sceneId, selfId, NPCId ) --未完成任务显示
			end
			if sceneId ~=150 then
        ...
        if level > x270351_g_PlayerMaxLevel then
			...
			x270351_DispatchMissionInfo( sceneId, selfId, NPCId )	--任务信息显示
		else
	    	local level = GetLevel( sceneId, selfId)
	        ...
	        if mod(Times,10) == 0 then
				x270351_DispatchMenuInfo( sceneId, selfId, NPCId )	--任务信息显示
			else
				x270351_DispatchMissionInfo( sceneId, selfId, NPCId )	--任务信息显示
			end
		end
...
function x270351_DelRequireMissionItem( sceneId, selfId)
	if DelItem( sceneId, selfId, x270351_g_AcceptItemID, 1) == 0 then
		Msg2Player( sceneId, selfId, format( "请您先去杂货商人处购买@item_%d#cffcf00!再来接受任务", x270351_g_AcceptItemID), 8, 3)
        return 0
    end
    return 1
end      
...
function x270351_AddAcceptMissionItem( sceneId, selfId)
    ...
    if ret > 0 then
    	Msg2Player( sceneId, selfId, format( "你获得了1个@item_%d!", x270351_g_SubmitItemID), 8, 3)
		...
		if completed == 1 then
			...
			if result == 1 then
                ...
                if DelItem( sceneId, selfId, x270351_g_ItemID, 1) == 0 then
                    Msg2Player( sceneId, selfId, format( "很抱歉，你没有@item_%d#cffcc00", x270351_g_ItemID), 8, 3)
                    return
                end
...
function x270351_GetBonus( sceneId, selfId,NpcID, SelectId, times)
	...
	if x270351_g_BonusMoney1 > 0 then
	    ...
	    Msg2Player(sceneId,selfId,format("获得#R银卡#{_MONEY%d}#cffcf00的奖励。", x270351_g_BonusMoney1 * level),4,2)
        Msg2Player(sceneId,selfId,format("获得#R银卡#{_MONEY%d}#cffcf00的奖励", x270351_g_BonusMoney1 * level),8,3)
	end

	--奖励金钱2
	if x270351_g_BonusMoney2 > 0 then
	    AddMoney( sceneId, selfId, 0, x270351_g_BonusMoney2 * level)
	    Msg2Player(sceneId,selfId,format("获得#R现银#{_MONEY%d}#cffcf00的奖励。", x270351_g_BonusMoney2 * level),4,2)
        Msg2Player(sceneId,selfId,format("获得#R现银#{_MONEY%d}#cffcf00的奖励", x270351_g_BonusMoney2 * level),8,3)
	end

	--奖励金钱1
	if x270351_g_BonusMoney3 > 0 then
	    AddMoney( sceneId, selfId, 3, x270351_g_BonusMoney3 )
	    Msg2Player(sceneId,selfId,format("获得金卡#{_MONEY%d}的奖励。", x270351_g_BonusMoney3),4,2)
	end
	...
	if x270351_g_BonusMoney4 > 0 then
		...
		Msg2Player(sceneId,selfId,format("获得江湖声望%d的奖励。", x270351_g_BonusMoney4),4,2)
	end
	...
	if x270351_g_BonusMoney5 > 0 then
		...
		Msg2Player(sceneId,selfId,format("获得朝廷声望%d的奖励。", x270351_g_BonusMoney5),4,2)
	end

	--朝廷声望
	if x270351_g_BonusMoney6 > 0 then
		AddHonor(sceneId,selfId,x270351_g_BonusMoney6)
		Msg2Player(sceneId,selfId,format("获得荣誉值%d的奖励。", x270351_g_BonusMoney6),4,2)
	end
...
function x270351_DispatchMenuInfo( sceneId, selfId, NPCId)
	BeginQuestEvent(sceneId)
		...
		local state = GetQuestStateNM(sceneId,selfId,NPCId,x270351_g_MissionId)
		AddQuestNumText(sceneId,x270351_g_MissionId,"我要领取三环通缉令",13,1000 )	
...
function x270351_DispatchCompletedInfo( sceneId, selfId, NPCId, nExtIdx)
    if nExtIdx == 30 then
        BeginQuestEvent(sceneId)
            ...
            local state = GetQuestStateNM( sceneId, selfId, NPCId, x270351_g_MissionId)
            AddQuestNumText( sceneId, x270351_g_MissionId, "使用悬赏令完成任务", 3, 31)
            AddQuestNumText( sceneId, x270351_g_MissionId, "直接完成任务", 3, 32)
        EndQuestEvent()
        DispatchQuestEventList( sceneId, selfId, NPCId)
    ...
    if teamSize <= 1 then -- 非组队，单独做任务
        ...
        for i = 0, teamSize - 1 do
            ...
            if memberId >= 0 and IsPlayerStateNormal( sceneId, memberId) == 1 then
                if IsHaveQuest( sceneId, memberId, x270351_g_MissionId) > 0 then -- 如果该成员接受了狩猎任务
...
--			BeginQuestEvent(sceneId);
--			AddQuestText(sceneId,"已获得"..x270351_g_ExtTarget[x270351_MP_TARGET1+1].target..":"..targetcount.."/"..x270351_g_ExtTarget[x270351_MP_TARGET1+1].n);
--			EndQuestEvent();
--			DispatchQuestTips(sceneId, selfId);
...
function x270351_QuestLogRefresh( sceneId, selfId, MissionId)
	...
	BeginQuestEvent(sceneId)
        ...
        AddQuestLogCustomText( sceneId,
                                "",                             -- 标题
                                format( "【个人】三环任务(通缉令)(%d/10)", x270351_GetTimes( sceneId, selfId) ),           -- 任务名字
