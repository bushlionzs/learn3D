...
x300874_g_MissionKind 				= 	1                       --任务类型
x300874_g_Mis_Count   = 1--每天可做的次数
x300874_g_MissionId = 7648;
x300874_g_ExtTarget					=	{ {type=20,n=1,target="马车"} }

--MisDescEnd

--子任务
x300874_g_SubMissionID				=	{ { MisID=7614,MissionName = "【个人】官府押运",LevelLess = 30,LevelMax = 40  }, 
										  {	MisID=7615,MissionName = "【个人】官府押运",LevelLess = 40,LevelMax = 50  },
										  {	MisID=7616,MissionName = "【个人】官府押运",LevelLess = 50,LevelMax = 60  },
										  {	MisID=7617,MissionName = "【个人】官府押运",LevelLess = 60,LevelMax = 70  },
										  {	MisID=7618,MissionName = "【个人】官府押运",LevelLess = 70,LevelMax = 80  },	
										  {	MisID=7619,MissionName = "【个人】官府押运",LevelLess = 80,LevelMax = 150  },											  
										}								
