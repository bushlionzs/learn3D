...
x700088_CSP_GUID_START              =   248  --空6个
x700088_CSP_FUBEN_TYPE				=	254	--试练，普通，英雄，三种类型0 -- 普通1 -- 试练2 -- 英雄
...
x700088_g_Talk_A					= "传说拥有不死之身的札兰丁刀枪不入，但我坚信你一定能够摧枯拉朽般的将他击败！"				
x700088_g_Talk_B					= "向我开炮，让火力来的更猛烈些吧！"								
x700088_g_Talk_C					= "让你尝尝我的厉害！"						
x700088_g_Talk_D					= "朋友们坚持住，由我来治愈你的伤痛！"	
...
function x700088_OnDie(sceneId, selfId, killerId)
	...
	if objId1 == selfId then
		SetFubenData_Param(sceneId, x700088_CSP_BOSS1_ID, -1)
		x700088_ShowTipsToAll(sceneId, "成功击杀象鼻邪神犍尼萨，副本完成。")
...
function x700088_CreateXianJinBoss(sceneId)
	...
	x700088_ShowTipsToAll(sceneId, "翻番宝箱出现！")
end