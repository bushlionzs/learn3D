...
x300769_g_MissionName				= 	"收集黑木" 
x300769_g_MissionInfo				= 	"巡按任务信息" 
--MisDescEnd

function x300769_ProcEnumEvent( sceneId, selfId, targetId )
end

function x300769_ProcEventEntry(sceneId, selfId,targetId)	--点击该任务后执行此脚本
		BeginQuestEvent(sceneId)
		local Readme_1 = "#Y【帮会】收集黑木#r#W"
		local Readme_2 = "  1，#G接取任务：#W帮会中，等级大于#G40级小于65级#W的帮会成员，每天可以自行接取此任务。#r"
