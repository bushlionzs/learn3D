...
x540014_g_AbilityName = "罗马铸甲术"
x540014_g_MissionName = "遗忘"..x540014_g_AbilityName
x540014_g_ContinueInfo="\t制造系生活技能分为六种：中原草药术、印度珠宝术、蒙古驯马术、突厥锻造术、罗马铸甲术、波斯工艺术。\n\t你最多学习其中三种制造系生活技能。如果你已经学满三种制造技能，又希望学习新的制造技能，可以到我这里遗忘"..x540014_g_AbilityName.."。\n\t遗忘技能后本生活技能相应称号也会消失，你希望遗忘"..x540014_g_AbilityName.."吗？"
...
function x540014_ProcAccept( sceneId, selfId )
	...
	if 0 == nStep then
		BeginQuestEvent(sceneId)
		AddQuestText(sceneId,"遗忘后技能等级无法恢复,您确定要遗忘罗马铸甲术吗?")
		EndQuestEvent()
	...
	elseif 1 == nStep then
		...
		if abilityLevel >0 then
			...
			if nRet == 1 then
				...
				BeginQuestEvent(sceneId)
				AddQuestText(sceneId, "您遗忘了"..x540014_g_AbilityName)
				DispatchQuestTips(sceneId, selfId)
				EndQuestEvent(sceneId)
				Msg2Player(sceneId,selfId,"您遗忘了"..x540014_g_AbilityName,8,2)
				--TipsToPlayer (sceneId,selfId,"您遗忘了"..x540014_g_AbilityName)
			...
			BeginQuestEvent(sceneId)
			AddQuestText(sceneId, "您还未学习"..x540014_g_AbilityName)
			DispatchQuestTips(sceneId, selfId)
			EndQuestEvent(sceneId)
			--TipsToPlayer (sceneId,selfId,"您还未学习"..x540014_g_AbilityName)
		end
	end
end