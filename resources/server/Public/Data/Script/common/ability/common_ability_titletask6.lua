...
x310706_g_MissionName				= "【个人】进阶工艺大师"
...
x310706_g_MissionInfo   = "\t想进阶为波斯工艺术的大师，必须要完成我的考验。\n\t但是要注意，一旦成功进阶，除非遗忘整个波斯工艺术，否则无法成为其他生活技能的大师。\n\t成为工艺大师可以学习9级波斯工艺术及一些特殊的波斯工艺术配方。\n\t你确定要接受考验吗？"           --任务信息
x310706_g_MissionHelp   = "所需的部件由生活技能制造，也可以从其他玩家处获得"          --任务提示信息
x310706_g_MissionTarget = "  收集@item_11041052#W三个\n  收集@item_11041010#W一个\n  收集@item_11041000#W一个\n  收集@item_11041020#W一个\n  收集@item_11041030#W一个\n  收集@item_11041040#W一个"      --任务目标
x310706_g_TitleBonus    = "称号：工艺大师（拥有此称号可以学习更多的工艺技能）"
...
function x310706_DoLearn(sceneId, selfId)
	...
	if level < x310706_g_AbillityLevel then
		return format("需要%d级的生活技能", x310706_g_AbillityLevel)
	end
...
function x310706_ProcEventEntry(sceneId, selfId, targetId, MissionId)
	...
	if IsHaveQuestNM( sceneId, selfId, MissionId ) == 1 then
		...
		if GetQuestParam( sceneId, selfId, misIndex, 7 ) == 1 then
			...
			BeginQuestEvent(sceneId)
			AddQuestText(sceneId,"\t你这就收集齐了所有的东西？看来你可以成为波斯工艺术大师了。")
			EndQuestEvent()
		...
		BeginQuestEvent(sceneId)
		AddQuestText(sceneId,"#Y【个人】进阶工艺大师\n\t#W你还没有收集齐我要的东西，收齐再来找我吧。")
		EndQuestEvent()
...
function x310706_QuestLogRefresh( sceneId, selfId, MissionId)
  ...
  BeginQuestEvent(sceneId)
	AddQuestLogCustomText( sceneId,
							x310706_g_MissionName,						-- 标题
							x310706_g_MissionName,        -- 任务名字
							szTarget,		--任务目标
							x310706_g_CommitNPC,			--任务NPC
							"  所需的部件由生活技能制造，也可以从其他玩家处获得\n \n#Y奖励内容：\n\t#W称号：工艺大师（拥有此称号可以学习更多的工艺技能）",               --任务攻略
							"\t想进阶为波斯工艺术的大师，必须要完成我的考验。\n\t但是要注意，一旦成功进阶，除非遗忘整个波斯工艺术，否则无法成为其他生活技能的大师。",	--任务描述
							""					--任务小提示
							)
	EndQuestEvent()
...
function x310706_ProcQuestAbandon(sceneId, selfId, MissionId)
	...
	local message = "您放弃了:"..x310706_g_MissionName
	BeginQuestEvent(sceneId);
