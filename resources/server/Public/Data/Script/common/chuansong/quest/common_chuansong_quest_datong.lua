...
x550536_g_MissionName="激活草原克烈部传送"
x550536_g_MissionInfo="#cffcf00您已经开通了#G草原克烈部#W#cffcf00传送！#W"  --任务描述
x550536_g_MissionTarget=""		
x550536_g_MissionCompleted=""					--完成任务npc说话的话
...
function x550536_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
