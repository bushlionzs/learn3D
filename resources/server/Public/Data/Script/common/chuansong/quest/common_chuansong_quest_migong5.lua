...
x550296_g_MissionName="激活王国迷宫五层传送"
x550296_g_MissionInfo="#cffcf00您已经开通了#G王国迷宫五层#W#cffcf00传送！#W"  --任务描述
x550296_g_MissionTarget=""		
x550296_g_MissionCompleted=""					--完成任务npc说话的话
...
function x550296_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
