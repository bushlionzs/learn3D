...
x550520_g_MissionName="激活领地莫斯科公国传送"
x550520_g_MissionInfo="#cffcf00您已经开通了#G领地莫斯科公国#W#cffcf00传送！#W"  --任务描述
x550520_g_MissionTarget=""		
x550520_g_MissionCompleted=""					--完成任务npc说话的话
...
function x550520_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
		return
