...
x550512_g_MissionName="激活王国边塞玉门关传送"
x550512_g_MissionInfo="#cffcf00您已经开通了#G王国边塞玉门关#W#cffcf00传送！#W"  --任务描述
x550512_g_MissionTarget=""		
x550512_g_MissionCompleted=""					--完成任务npc说话的话
...
function x550512_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
		return
end
