...
x552007_g_ask ={"前往领地-莫斯科公国","确定"}
x552007_g_answer ={"\t只要你付出1两400文现银或银卡，我就可以将你送往领地-莫斯科公国。\n\t你确认要前往领地-莫斯科公国吗？"}
x552007_g_Notice = "您的等级还不足#R40级#Y，无法进入领地-莫斯科公国！"

function x552007_ProcEventEntry(sceneId, selfId, NPCId, MissionId,which)	--点击该任务后执行此脚本
