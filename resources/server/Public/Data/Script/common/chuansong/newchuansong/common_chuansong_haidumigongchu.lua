...
x550203_g_MissionName = "离开这里"
x550203_g_MissionInfo=" 我可以将你送回村里。"  --任务描述
x550203_g_MissionInfo2=""
--x550203_g_MissionQuestID	=	2723
x550203_g_MissionComplete="  "					--完成任务npc说话的话
...
function x550203_ProcEventEntry(sceneId, selfId, targetId)	--点击该任务后执行此脚本
