...
x550402_g_MissionName1 = "前往楼兰边塞"
x550402_g_MissionName2 = "前往天山边塞"
x550402_g_MissionName3 = "前往昆仑边塞"
x550402_g_MissionName4 = "前往敦煌边塞"   
x550402_g_SceneID1 =51								--楼兰边境场景ID
x550402_g_SceneID2 =151	  						 --天山边境场景ID
x550402_g_SceneID3 =251								--昆仑边境场景ID
x550402_g_SceneID4 =351								--敦煌边境场景ID
x550402_g_MissionInfo=" "  --任务描述
x550402_g_MissionInfo2=""
x550402_g_MissionQuestID	=	-1
x550402_g_MissionComplete="  "					--完成任务npc说话的话
x550402_g_ContinueInfo="    "
x550402_g_Notice = "您的等级还不足#R40级#Y，无法前往其他国家！"
--任务奖励
...
function x550402_ProcEventEntry(sceneId, selfId, targetId)	--点击该任务后执行此脚本
