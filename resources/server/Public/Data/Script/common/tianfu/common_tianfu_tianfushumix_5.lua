...
x570062_g_ScriptName = "五级平衡之书合成"
x570062_g_UICommandID = 100
x570062_g_Mixture_RESULT_LESS = -2  --物品不正确
x570062_g_Mixture_RESULT_FAILD = -1	--物品合成失败，有概率失败
x570062_g_Mixture_RESULT_OK = 1	--物品合成成功
x570062_g_Mixture_AddItem_UseType = 0	--特定物品使用类型 对应代码 eITEM_SPECIAL_USETYPE
...
function x570062_ProcEventEntry( sceneId, selfId, targetId, MissionId )--告知客户端打开合成界面
