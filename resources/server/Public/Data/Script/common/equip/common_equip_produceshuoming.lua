...
x800085_g_MissionName1="【装备锻造说明】"
x800085_g_MissionInfo1="\t通过锻造可以制作出冥级装备。锻造过程消耗冥界声望石和冥之龙眼石。\n#Y操作说明#W：\n\t1.与王国#G装备锻造大师（312，93）#W或大都#G装备锻造大师（278，209）#W对话。\n\t2.选择#G装备锻造#W选项。\n\t3.点击装备锻造界面上方#G选择套装种类下拉条#W，选择套装种类。\n\t4.点击界面上方#G选择套装部件下拉条#W，选择套装部件。\n\t5.点击界面下方锻造按钮。\n#Y注意事项#W：\n\t锻造出来的装备，其属性是#G随机#W的。"  --任务描述
--x800085_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800085_g_MissionCompleted1=""--完成任务npc说话的话
--x800085_g_MissionCompleted2=""--完成任务npc说话的话
--x800085_g_ContinueInfo1="\t你将要x800085_g_MissionName5。\n\t将扣除您的龙眼石x800085_g_NeedNum1颗。"
...
function x800085_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
