...
x800073_g_MissionName1="【装备打孔说明】"
x800073_g_MissionInfo1="\t装备打孔之后，可以在孔内镶嵌宝石，增加装备的属性。打孔需要消耗银币和打孔钻。\n#Y操作说明#W：\n\t1.与王国#G装备镶嵌大师#W或大都#G装备镶嵌大师#W对话。\n\t2.选择#G装备打孔#W选项，打开装备打孔界面。\n\t3.将所要打孔的装备放入到装备打孔界面左上方格子内。\n\t4.点击界面下方打孔按钮。\n#Y注意事项#W：\n\t#G35级以上#W的玩家才能使用此功能。"  --任务描述
--x800073_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800073_g_MissionCompleted1=""--完成任务npc说话的话
--x800073_g_MissionCompleted2=""--完成任务npc说话的话
--x800073_g_ContinueInfo1="\t你将要x800073_g_MissionName5。\n\t将扣除您的龙眼石x800073_g_NeedNum1颗。"
...
function x800073_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
