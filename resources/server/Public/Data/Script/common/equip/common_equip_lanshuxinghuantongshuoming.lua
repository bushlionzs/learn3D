...
x800091_g_MissionName1="【装备回炉（洗蓝）说明】"
x800091_g_MissionInfo1="\t在不改变装备强化次数的情况下，对强化的蓝属性值进行重置，使其重新分配装备蓝属性条目中。装备回炉（洗蓝）所需的道具为：蓝光火石（金币商城装备打造区装备强化类出售）。\n\t#R注意：#G命中、闪避、暴击、韧性、暴击伤害#R属性每强化三次才能上升1点。\n#Y操作说明#W：\n\t1.与王国#G装备鎏金大师#W或大都#G装备鎏金大师#W对话。\n\t2.选择#G装备回炉（洗蓝）#W选项。\n\t3.将已做过装备鎏金（洗蓝）的装备放入到装备回炉（洗蓝）界面左上方格子内。\n\t4.点击界面下方重置按钮。\n#Y注意事项#W：\n\t只有#G装备鎏金（洗蓝）过的装备#W才能使用此功能。"  --任务描述
--x800091_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800091_g_MissionCompleted1=""--完成任务npc说话的话
--x800091_g_MissionCompleted2=""--完成任务npc说话的话
--x800091_g_ContinueInfo1="\t你将要x800091_g_MissionName5。\n\t将扣除您的龙眼石x800091_g_NeedNum1颗。"
...
function x800091_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
