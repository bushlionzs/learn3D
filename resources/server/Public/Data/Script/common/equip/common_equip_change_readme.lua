...
x800092_g_MissionName1="【装备转换说明】"
x800092_g_MissionInfo1="\t进行装备转换时，你需要拥有#G装备转换符#W，并且你的装备只能转换为对应职业的装备。\n\t具体装备转换对应为：\n\t#G突厥武士#W可转换为#G地中海十字军#W\n\t#G江南剑侠#W可转换为#G西域圣火使#W\n\t#G蒙古骑射手#W可转换为#G西夏刺客#W\n\t#G中原火枪手#W可转换为#G蒙古近卫军#W\n\t#G波斯先知#W可转换为#G斯拉夫隐修士#W\n\t#G雪山萨满#W可转换为#G高原僧侣#W\n#Y注意事项#W：\n\t只有#G黄色装备#W和#G紫色装备#W才能进行装备转换！"  --任务描述
--x800092_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800092_g_MissionCompleted1=""--完成任务npc说话的话
--x800092_g_MissionCompleted2=""--完成任务npc说话的话
--x800092_g_ContinueInfo1="\t你将要x800092_g_MissionName5。\n\t将扣除您的龙眼石x800092_g_NeedNum1颗。"
...
function x800092_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
