...
x800114_g_MissionName1="【时装纹龙说明】"
x800114_g_MissionInfo1="\t时装纹龙可以提升时装的属性，龙的数量越多提升的属性越高。纹龙需要消耗金龙印道具（天上人间·梦聊内挖宝大作战发布人、天降魔君发布人、倩女幽魂发布人、画皮副本发布人、时装纹龙大师处兑换而来）。时装最多可以纹龙五次，五龙时装的强大是不言而喻的。\n \n#Y操作说明#W：\n\t1.与王城外装大师、大都外装大师或梦聊中时装纹龙大师对话。\n\t2.选择时装纹龙选项，打开时装纹龙界面。\n\t3.将所要纹龙的时装放入到时装纹龙界面左上方格子内。\n\t4.选择纹龙使用的道具。\n\t5.点击界面下方纹龙按钮开始给时装纹龙。\n\t6.如果需要使用自动纹龙的功能，则可以在选择自动纹龙等级的下拉条内，选择自动纹龙等级，点击自动纹龙按钮即可。当银币或金龙印不足或纹龙已到选择的等级和最高级时，都会自动停止纹龙。\n \n#Y注意事项#W：\n\t#G85级以上#W的玩家才能使用该功能。\n\t时装最多可纹龙五次；当符合操作条件时，每次纹龙一定会成功。"  --任务描述
--x800114_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800114_g_MissionCompleted1=""--完成任务npc说话的话
--x800114_g_MissionCompleted2=""--完成任务npc说话的话
--x800114_g_ContinueInfo1="\t你将要x800114_g_MissionName5。\n\t将扣除您的龙眼石x800114_g_NeedNum1颗。"
...
function x800114_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
