...
x800082_g_MissionName1="【护身符上色说明】"
x800082_g_MissionInfo1="\t护身符上色可以将符文吸收的蓝色属性添加到护身符上。护身符上色消耗银币和符文。\n#Y操作说明#W：\n\t1.与王国#G外装大师#W或大都#G外装大师#W对话。\n\t2.选择#G护身符上色#W选项。\n\t3.将护身符放入到护身符上色界面左上方格子内。\n\t4.将符文放入到护身符上色界面下方格子内。\n\t5.点击界面下方上色按钮。\n#Y注意事项#W：\n\t一个护身符不能上色两个同种符文。"  --任务描述
--x800082_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800082_g_MissionCompleted1=""--完成任务npc说话的话
--x800082_g_MissionCompleted2=""--完成任务npc说话的话
--x800082_g_ContinueInfo1="\t你将要x800082_g_MissionName5。\n\t将扣除您的龙眼石x800082_g_NeedNum1颗。"
...
function x800082_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
