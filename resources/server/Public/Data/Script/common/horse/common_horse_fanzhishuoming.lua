...
x570051_g_MissionName1="【骑乘繁殖说明】"
x570051_g_MissionInfo1="\t骑乘繁殖可以通过两个#G同类型#W的#G一代宝宝#W骑乘，繁殖出属性更高的#G变异#W骑乘。骑乘繁殖消耗银币。\n#Y操作说明#W：\n\t1.与王国#G骑乘繁殖大师#W或大都#G骑乘繁殖大师#W对话。\n\t2.选择#G骑乘繁殖#W选项，打开骑乘繁殖界面。\n\t3.在骑乘繁殖界面左方主骑乘下拉条中选择主骑乘。\n\t4.在骑乘繁殖界面右方主骑乘下拉条中选择副骑乘。\n#Y注意#W：\n\t1.主骑乘等级不可低于60级。\n\t2.繁殖后主、副骑乘都将失去。\n\t3.繁殖出的骑乘#G资质#W保留主骑乘的资质并有所提升。\n\t4.繁殖出的骑乘保留主骑乘的所有#G技能#W。\n\t5.繁殖出的骑乘的#G初始基础属性#W和副骑乘的初始属性一致。\n\t6.繁殖出的骑乘#G等级#W为1级。"  --任务描述
--x570051_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x570051_g_MissionCompleted1=""--完成任务npc说话的话
--x570051_g_MissionCompleted2=""--完成任务npc说话的话
--x570051_g_ContinueInfo1="\t你将要x570051_g_MissionName5。\n\t将扣除您的龙眼石x570051_g_NeedNum1颗。"
...
function x570051_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
