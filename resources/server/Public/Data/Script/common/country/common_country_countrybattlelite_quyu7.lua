...
x310146_g_Time					= { min = 2000,max = 2059 }	--时间限制
x310146_g_minsterGuid			= 129746					--屠城战国家军力GUID
x310146_g_PreTime				=  0
x310146_g_AreaTipsInterval		=  2						--区域事件间隔
x310146_g_AreaTips				= "#R警报！敌国正在攻击我国外城#aB{goto_%d,%d,%d}(%d,%d)#aE的兵部参军，请火速救援！"
--MisDescEnd
----------------------------------------------------------------------------------------------
