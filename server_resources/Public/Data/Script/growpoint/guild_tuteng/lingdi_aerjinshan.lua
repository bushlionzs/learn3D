--生长点
--MisDescBegin
x301458_g_GrowpointId = 124 --对应生长点ID
x301458_g_ItemIndex = 13011604 --对应收集物品的ID
x301458_g_BufIndex = 7600
x301458_g_GroupPoint	=	{ {type=10,id =124,target = "丹木"}}
--MisDescEnd
	...
	if level <=  75 then
		if sceneId == 9 then
			 ...
			 if nRet <= 10 then --采集点全部变怪
					...
					local msg1 = "由于"..name.."在收集图腾时触发了天变，碎叶城附近出现天龙之魂"
