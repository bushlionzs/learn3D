...
x550521_g_MissionName="激活领地匈牙利王国传送"
x550521_g_MissionInfo="#cffcf00您已经开通了#G领地匈牙利王国#W#cffcf00传送！#W"  --任务描述
x550521_g_MissionTarget=""		
x550521_g_MissionCompleted=""					--完成任务npc说话的话
...
function x550521_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
