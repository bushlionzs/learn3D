...
x550535_g_MissionName="激活草原乃蛮部传送"
x550535_g_MissionInfo="#cffcf00您已经开通了#G草原乃蛮部#W#cffcf00传送！#W"  --任务描述
x550535_g_MissionTarget=""		
x550535_g_MissionCompleted=""					--完成任务npc说话的话
...
function x550535_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
