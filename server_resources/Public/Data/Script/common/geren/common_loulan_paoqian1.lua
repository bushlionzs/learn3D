...
x300757_g_ScriptId 					= 	300757                  --脚本ID

x300757_g_MissionKind 				= 	1                       --任务类型
x300757_g_LevelLess					= 	30                      --任务最小等级  <=0 表示不限制

x300757_g_MissionTarget				= 	"将货物安全运到@npc_137501"          --任务目标
x300757_g_MissionInfo				= 	"\t杀死@npc_72004的@npc_72005,找到@npc_137600"            --任务信息
x300757_g_ContinueInfo				= 	"怎么还没人送货过来啊？今天送货的人呢？"  --任务继续信息
x300757_g_MissionCompleted			= 	"一路辛苦了，这是给您的奖励，请收下！"  --任务完成信息
x300757_g_MissionHelp				=	""          --任务提示信息

--目标
x300757_g_ExtTarget					=	{ {type=20,n=1,target="@npc_72005"} }


--奖励
x300757_g_BonusItem					=	{}	--奖励：物品
x300757_g_BonusMoney6               =   0  --任务奖励荣誉

x300757_g_BonusChoiceItem           =   {}

x300757_g_Mis_Count   = 3				--每天可做的次数

--MisDescEnd

--任务目标顺序
x300757_MP_ISCOMPLETE				= 7	--代表完成 0未完成， 1完成

--任务物品
x300757_TARGET_ITEMID1				= -2

--x300757_SubmitNPCGUID				= 137501	--交任务NPC GUID

x300757_g_BusScriptId				= 300760

--子任务																	   
x300757_g_SubMissionID				=	{ { MissionId=7556, MissionName = "【个人】黑金押运", MissionTarget = "  将飞行器交给@npc_123829", MissionInfo = "\t一路小赚，押的少风险小啊。\n\t您可以通过王国押运官并抵押#G5两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G2两现银(银卡)#W工钱。\n\t您必须#R绑定密保卡后#W才能领取任务。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",MissionHelp = "\t您必须#R绑定密保卡后#W才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#G停止前进#W。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#G任务失败#W，您的#G押金#W将丢失。", SubmitNPCGUID = 123829, iCostMoney =5000, BonusMoney = 2000, ExpBonus = 0,NPCName = "@npc_123829",Missionruse="将运金飞行器送到楼兰外城的@npc_125513处！",AcceptId = 281,SubmitId = 282,LevelLess	= 30,LevelMax = 40,BaoDanId=13080011 }, 
										  {	MissionId=7557, MissionName = "【个人】黑金押运", MissionTarget = "  将飞行器交给@npc_125513", MissionInfo = "\t略有风险，满足一点点小贪心。\n\t您可以通过王国押运官并抵押#G10两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G4两现银(银卡)#W工钱。\n\t您必须#R绑定密保卡后#W才能领取任务。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",MissionHelp = "\t您必须#R绑定密保卡后#W才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#G停止前进#W。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#G任务失败#W，您的#G押金#W将丢失。",	SubmitNPCGUID = 125513, iCostMoney = 10000, BonusMoney = 4000, ExpBonus = 0,NPCName = "@npc_125513",Missionruse="将运金飞行器送到楼兰古道的@npc_125513处！",AcceptId = 291,SubmitId = 292,LevelLess = 40,LevelMax = 50,BaoDanId=13080012 },
										  {	MissionId=7558, MissionName = "【个人】黑金押运", MissionTarget = "  将飞行器交给@npc_125512", MissionInfo = "\t舍得，舍得，不舍哪会有得？下定决心才能大富大贵，风险大回报一定丰厚。\n\t您可以通过王国押运官并抵押#G15两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G6两现银(银卡)#W工钱。\n\t您必须#R绑定密保卡后#W才能领取任务。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",MissionHelp = "\t您必须#R绑定密保卡后#W才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#G停止前进#W。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#G任务失败#W，您的#G押金#W将丢失。",SubmitNPCGUID = 125512, iCostMoney = 15000,BonusMoney = 6000,ExpBonus = 0,NPCName = "@npc_125512",Missionruse="将运金飞行器送到边塞的@npc_125512处！",AcceptId = 301,SubmitId = 302,LevelLess = 50,LevelMax = 60,BaoDanId=13080013 },
										  {	MissionId=7546, MissionName = "【个人】黑金押运", MissionTarget = "  将飞行器交给@npc_125512", MissionInfo = "\t舍得，舍得，不舍哪会有得？下定决心才能大富大贵，风险大回报一定丰厚。\n\t您可以通过王国押运官并抵押#G30两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G12两现银(银卡)#W工钱。\n\t您必须#R绑定密保卡后#W才能领取任务。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",MissionHelp = "\t您必须#R绑定密保卡后#W才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#G停止前进#W。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#G任务失败#W，您的#G押金#W将丢失。",SubmitNPCGUID = 125512, iCostMoney = 30000,BonusMoney = 12000,ExpBonus = 0,NPCName = "@npc_125512",Missionruse="将运金飞行器送到边塞的@npc_125512处！",AcceptId = 761,SubmitId = 762,LevelLess = 60,LevelMax = 70,BaoDanId=13080014 },
										  { MissionId=7547, MissionName = "【个人】黑金押运", MissionTarget = "  将飞行器交给@npc_125512", MissionInfo = "\t舍得，舍得，不舍哪会有得？下定决心才能大富大贵，风险大回报一定丰厚。\n\t您可以通过王国押运官并抵押#G40两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G16两现银(银卡)#W工钱。\n\t您必须#R绑定密保卡后#W才能领取任务。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",MissionHelp = "\t您必须#R绑定密保卡后#W才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#G停止前进#W。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#G任务失败#W，您的#G押金#W将丢失。",SubmitNPCGUID = 125512, iCostMoney = 40000,BonusMoney = 16000,ExpBonus = 0,NPCName = "@npc_125512",Missionruse="将运金飞行器送到边塞的@npc_125512处！",AcceptId = 771,SubmitId = 772,LevelLess = 70,LevelMax = 80,BaoDanId=13080015 },
										  { MissionId=7548, MissionName = "【个人】黑金押运", MissionTarget = "  将飞行器交给@npc_125512", MissionInfo = "\t舍得，舍得，不舍哪会有得？下定决心才能大富大贵，风险大回报一定丰厚。\n\t您可以通过王国押运官并抵押#G50两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G20两现银(银卡)#W工钱。\n\t您必须#R绑定密保卡后#W才能领取任务。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",MissionHelp = "\t您必须#R绑定密保卡后#W才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#G停止前进#W。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#G任务失败#W，您的#G押金#W将丢失。",SubmitNPCGUID = 125512, iCostMoney = 50000,BonusMoney = 20000,ExpBonus = 0,NPCName = "@npc_125512",Missionruse="将运金飞行器送到边塞的@npc_125512处！",AcceptId = 781,SubmitId = 782,LevelLess = 80,LevelMax = 150,BaoDanId=13080016 },
										}
						
--**********************************
--列举事件
--**********************************
function x300757_ProcEnumEvent( sceneId, selfId, NPCId, MissionId )
	return 0;
end
...
--任务入口函数
--**********************************
function x300757_ProcEventEntry(sceneId, selfId, NPCId, MissionId,nExtIdx)	--点击该任务后执行此脚本
		
	local index = 1
	for i,itm in x300757_g_SubMissionID do
		if i == nExtIdx then
	...
	if(bHaveMission > 0) then
		local bDone = x300757_CheckSubmit(sceneId, selfId, NPCId, index);
		if(bDone > 0) then
			if nExtIdx ~= -1 then
				x300757_DispatchCompletedInfo( sceneId, selfId, NPCId,index) --完成任务显示
			end
		else
			if nExtIdx ~= -1 then
				x300757_DispatchContinueInfo( sceneId, selfId, NPCId,index ) --未完成任务显示
			end
		end
	else
		local npcGuid = GetMonsterGUID(sceneId,NPCId)
		if x300757_g_SubMissionID[index].SubmitNPCGUID ~= npcGuid then
			x300757_DispatchMissionInfo( sceneId, selfId, NPCId,index )	--任务信息显示
		else
...
--检测接受条件
---------------------------------------------------------------------------------------------------
function x300757_ProcAcceptCheck( sceneId, selfId,MissionID )
	...
	for BaoDanId,BaoDanItm in x300757_g_SubMissionID do
	...
	local LevelLess = x300757_g_SubMissionID[1].LevelLess
	local LevelMax = x300757_g_SubMissionID[1].LevelMax
	for i,itm in x300757_g_SubMissionID do
	...
	if x300757_GetDayCount(sceneId, selfId) >= x300757_g_Mis_Count then
	  	BeginQuestEvent(sceneId)
...
--接受条件
---------------------------------------------------------------------------------------------------
function x300757_ProcQuestAccept( sceneId, selfId,targetID,MissionID )
	if ( x300757_ProcAcceptCheck( sceneId, selfId,MissionID ) ~= 1 ) then
	...
	for i,itm in x300757_g_SubMissionID do
		if MissionID == itm.MissionId then
			CallScriptFunction( x300757_g_BusScriptId, "OnCreateBus", sceneId, selfId ,MissionID,i)
			break
		end
	end
...
function  x300757_OnDatiFail(sceneId, selfId)
	...
	if GetGameOpenById(1018)>0 then
		...
		x300757_SetDayCount(sceneId, selfId)
	end
end

function x300757_OnHeiJinDatiSuccess(sceneId, selfId)
	...
	if ( x300757_ProcAcceptCheck( sceneId, selfId,nMissionId ) ~= 1 ) then
	...
	for i,itm in x300757_g_SubMissionID do
		if nMissionId == itm.MissionId then
			CallScriptFunction( x300757_g_BusScriptId, "OnCreateBus", sceneId, selfId ,nMissionId,i)
			break
		end
	end
...
--检查任务是否可提交
---------------------------------------------------------------------------------------------------
function x300757_CheckSubmit(sceneId, selfId, NPCId, index)
...
--放弃任务
---------------------------------------------------------------------------------------------------
function x300757_ProcQuestAbandon(sceneId, selfId, MissionId)
...
--获得奖励
---------------------------------------------------------------------------------------------------
function x300757_GetBonus( sceneId, selfId,NpcID, SelectId,MissionId )
...
--奖励金钱1
	...
	if iCostMoney > 0 then
 	...
 	--奖励固定物品
	for i, item in x300757_g_BonusItem do
	...
	--奖励可选物品
	for i, item in x300757_g_BonusChoiceItem do
...
---------------------------------------------------------------------------------------------------
function x300757_ProcQuestSubmit(sceneId, selfId, NPCId, selectRadioId,MissionId)
	...
	if bHaveMission > 0 then
		...
		local result = x300757_CheckPlayerBagFull(sceneId,selfId,selectRadioId)
		if result == 1 then
			...
			x300757_GetBonus( sceneId,selfId,NPCId,selectRadioId,MissionId )
...
--检查玩家包裹已满
---------------------------------------------------------------------------------------------------
function x300757_CheckPlayerBagFull( sceneId ,selfId,selectRadio )
	...
	--普通的奖励检查
	BeginAddItem(sceneId)
	for j, item in x300757_g_BonusItem do
		AddItem( sceneId, item.item, item.n )
    end

	for j, item in x300757_g_BonusChoiceItem do
...
--向客户端发送任务信息
---------------------------------------------------------------------------------------------------
function x300757_DispatchMissionInfo( sceneId, selfId, NPCId,index )

	BeginQuestEvent(sceneId)

		--任务信息
		AddQuestText(sceneId,"#Y"..x300757_g_SubMissionID[index].MissionName)
		AddQuestText(sceneId,format("%s", x300757_g_SubMissionID[index].MissionInfo))
		...
		if x300757_g_MissionHelp ~= "" then
			...
			AddQuestText(sceneId,format("%s", x300757_g_SubMissionID[index].MissionHelp))
			AddQuestText(sceneId," ")
		end
		...
		--1、经验
		local ExpBonus = x300757_g_SubMissionID[index].ExpBonus
		if ExpBonus > 0 then
			local level = GetLevel(sceneId, selfId)
			ExpBonus = x300757_g_SubMissionID[index].ExpBonus * level
			AddQuestExpBonus(sceneId, ExpBonus )
		end

		--2、金钱1

		if x300757_g_SubMissionID[index].BonusMoney > 0 then
    		local buffId1 = 9011
	        local buffId2 = 9013
	        local buffId3 = 9012
	        local bHaveImpact1 = IsHaveSpecificImpact( sceneId, selfId, buffId1 )
			...
			AddQuestMoneyBonus2(sceneId, x300757_g_SubMissionID[index].BonusMoney )
		    else 
		    AddQuestMoneyBonus1(sceneId, x300757_g_SubMissionID[index].BonusMoney )
		end
		end

		--荣誉值
		if x300757_g_BonusMoney6 > 0 then
			AddQuestMoneyBonus6(sceneId, x300757_g_BonusMoney6 )
		end
	...
	EndQuestEvent(sceneId)
	DispatchQuestInfoNM(sceneId, selfId, NPCId, x300757_g_ScriptId, x300757_g_SubMissionID[index].MissionId);
end

---------------------------------------------------------------------------------------------------
--向客户端发送任务未完成
---------------------------------------------------------------------------------------------------
function x300757_DispatchContinueInfo( sceneId, selfId, NPCId,index )
	...
	BeginQuestEvent(sceneId)
		...
		if x300757_g_SubMissionID[index].BonusMoney > 0 then
			...
			AddQuestMoneyBonus(sceneId, x300757_g_SubMissionID[index].BonusMoney )
	...
	EndQuestEvent()
	--DispatchQuestEventList(sceneId,selfId,NPCId);
	DispatchQuestDemandInfo(sceneId, selfId, NPCId, x300757_g_ScriptId, x300757_g_SubMissionID[index].MissionId,0);
...
--向客户端发送任务完成信息
---------------------------------------------------------------------------------------------------
function x300757_DispatchCompletedInfo( sceneId, selfId, NPCId,index )
	
	BeginQuestEvent(sceneId)

		--任务完成信息
		AddQuestText(sceneId,"#Y"..x300757_g_SubMissionID[index].MissionName)
		AddQuestText(sceneId,x300757_g_MissionCompleted)
		AddQuestText(sceneId," ")
	...
	EndQuestEvent(sceneId)
	DispatchQuestContinueInfoNM(sceneId, selfId, NPCId, x300757_g_ScriptId, x300757_g_SubMissionID[index].MissionId);
...
--单击NPC事件
---------------------------------------------------------------------------------------------------
function x300757_ProcQuestAttach( sceneId, selfId, npcId, npcGuid, misIndex, MissionId )
	for i,itm in x300757_g_SubMissionID do
		local bHaveMission = IsHaveQuestNM(sceneId, selfId,itm.MissionId );
...
--任务日志刷新
---------------------------------------------------------------------------------------------------
function x300757_QuestLogRefresh( sceneId, selfId, MissionId)
...
function x300757_ProcQuestLogRefresh( sceneId, selfId, MissionId)

	x300757_QuestLogRefresh( sceneId, selfId, MissionId );
end

function x300757_CostMoney( sceneId, selfId,MissionID )
	for i,itm in x300757_g_SubMissionID do
		if MissionID == itm.MissionId  then
...
function x300757_ProcQuestObjectKilled( sceneId, selfId, objdataId, objId, MissionId )
end
...
--取得此任务当天当前已完成次数
---------------------------------------------------------------------------------------------------
function x300757_GetDayCount(sceneId, selfId)

	if x300757_g_Mis_Count > 0 then
...
--更新当天接任务次数
---------------------------------------------------------------------------------------------------
function x300757_SetDayCount(sceneId, selfId)
	local today = GetDayOfYear()
