...
x310333_g_ScriptName = "【麒麟寻宝图合成】"
x310333_g_UICommandID = 100
x310333_g_Mixture_RESULT_LESS = -2  --物品不正确
x310333_g_Mixture_RESULT_FAILD = -1	--物品合成失败
x310333_g_Mixture_RESULT_OK = 1	--物品合成成功
...
function x310333_ProcEventEntry( sceneId, selfId, targetId, MissionId )--告知客户端打开合成界面
