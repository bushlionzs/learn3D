...
function x800039_ProcEventEntry( sceneId, selfId, targetId )	--点击该任务后执行此脚本
	local Readme_1 = "#Y【师徒】查找师傅#r"
	local Readme_2 = "\t#W您可以通过我的帮助找到您心仪的师傅，成功结成师徒关系可在未来的日子里获得丰厚的奖励。#r\t您是否要#G查找师傅#W？"
