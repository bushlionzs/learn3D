...
x310346_g_MissionName1="【挖宝大作战说明】"
x310346_g_MissionInfo1="挖宝大作战的规则：\n\t1.挖宝大作战在每周六、日的下午14：00——17：00举行。\n\t2.在活动期间每人可以进行两轮挖宝大作战。\n\t3.任务需要在天上人间·聊斋里面的20个地点进行挖宝。\n\t4.挖宝工具分为梦幻铁铲和梦幻金铲，使用梦幻金铲在挖宝过程中的收益高于梦幻铁铲。\n\t5.梦幻铁铲可在任务发布npc处购买，梦幻金铲可在金币商城（快捷键J）购买。\n\t6.当天完成任务用时最短的20名玩家会得到额外的奖励，取每天自己最好成绩参与排名。"  --任务描述
--x310346_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x310346_g_MissionCompleted1=""--完成任务npc说话的话
--x310346_g_MissionCompleted2=""--完成任务npc说话的话
--x310346_g_ContinueInfo1="\t你将要x310346_g_MissionName5。\n\t将扣除您的龙眼石x310346_g_NeedNum1颗。"
...
function x310346_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
