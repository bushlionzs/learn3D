...
x800072_g_MissionName1="【装备升星说明】"
x800072_g_MissionInfo1="\t装备升星可以提升装备的基础属性，星级越高提升的属性越多。升星需要消耗银币、水晶或钻石。\n#Y操作说明#W：\n\t1.与王国#G装备升星大师#W或大都#G装备升星大师#W对话。\n\t2.选择#G装备升星#W选项，打开装备升星界面。\n\t3.将所要升星的装备放入到装备升星界面左上方格子内。\n\t4.在选择宝石种类下拉条内，选择升星使用的宝石。\n\t5.点击界面下方打星按钮开始给装备升星。\n\t6.如果需要使用自动打星的功能，则可以在选择自动打星等级的下拉条内，选择自动打星等级，点击自动打星按钮即可，当银币或水晶、钻石不足，或装备已升级至选择的等级，自动打星将会自动停止。\n#Y注意事项#W：\n\t1.装备前三星的升级一定成功，升到四星及四星以上都#G有几率升星失败#W。\n\t2.使用#G水晶#W给装备升星，升4星以上时失败，装备星级回退到3星。\n\t3.使用#G钻石#W给装备升星，升星失败时，装备星级不会下降，保持升星前等级。"  --任务描述
--x800072_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800072_g_MissionCompleted1=""--完成任务npc说话的话
--x800072_g_MissionCompleted2=""--完成任务npc说话的话
--x800072_g_ContinueInfo1="\t你将要x800072_g_MissionName5。\n\t将扣除您的龙眼石x800072_g_NeedNum1颗。"
...
function x800072_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
