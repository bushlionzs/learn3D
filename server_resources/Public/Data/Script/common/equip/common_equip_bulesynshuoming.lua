...
x800111_g_MissionName1="【护身符补色说明】"
x800111_g_MissionInfo1="\t护身符补色可以将两个吸收了蓝色属性的符文合成一个更强大的符文，最多可以合成五次。将合成后的符文上色到护身符中，可以让护身符发挥更强大的威力。护身符补色需要消耗五彩石（天上人间·梦聊中挖宝大作战、天降魔君玩法和倩女幽魂、画皮副本有概率产出）。\n#Y操作说明#W：\n\t1.与王国#G外装大师#W，大都#G外装大师#W或梦聊中#G护身符补色大师#W对话。\n\t2.选择#G护身符补色#W选项。\n\t3.将主符文放入到界面左上方格内。\n\t4.将副符文放入到界面左下方格内。\n\t5.点击界面下方补色按钮。\n#Y注意事项#W：\n\t1.#G85级以上#W的玩家才能使用该功能。\n\t2.合成过的符文只能做为主符文进行再次合成。\n\t3.符文最多只能合成五次。\n\t4.副符文只有一定百分比的属性能合成到主符文上。"  --任务描述
--x800111_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800111_g_MissionCompleted1=""--完成任务npc说话的话
--x800111_g_MissionCompleted2=""--完成任务npc说话的话
--x800111_g_ContinueInfo1="\t你将要x800111_g_MissionName5。\n\t将扣除您的龙眼石x800111_g_NeedNum1颗。"
...
function x800111_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
