...
x800080_g_MissionName1="【麻将铭刻说明】"
x800080_g_MissionInfo1="\t装备进行麻将铭刻会增加麻将属性，也可更替装备现有的麻将属性。麻将铭刻消耗银币、麻将牌或乱士符。\n#Y操作说明#W：\n\t1.与王国#G装备铭刻大师#W或大都#G装备铭刻大师#W对话。\n\t2.选择#G麻将铭刻#W选项。\n\t3.将装备放入到麻将铭刻界面左上方格子内。\n\t4.将麻将牌或乱士符放入到麻将铭刻界面下方格子内\n\t5.点击界面下方确定按钮。\n#Y注意事项#W：\n\t#G65级以上#W人物才可进行麻将铭刻。"  --任务描述
--x800080_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800080_g_MissionCompleted1=""--完成任务npc说话的话
--x800080_g_MissionCompleted2=""--完成任务npc说话的话
--x800080_g_ContinueInfo1="\t你将要x800080_g_MissionName5。\n\t将扣除您的龙眼石x800080_g_NeedNum1颗。"
...
function x800080_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
