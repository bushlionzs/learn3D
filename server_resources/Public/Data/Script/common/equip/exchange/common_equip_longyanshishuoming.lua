...
x570000_g_MissionName1="龙眼石兑换说明"
x570000_g_MissionInfo1="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传，冥传五种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。冥传装备需要#G冥之龙眼石#W。\n\t我现在能为您兑换世传装备！"  --任务描述
x570000_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传，冥传五种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。冥传装备需要#G冥之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备、天传装备和冥传装备！"  --任务描述
x570000_g_MissionCompleted1=""--完成任务npc说话的话
x570000_g_MissionCompleted2=""--完成任务npc说话的话
x570000_g_ContinueInfo1="\t你将要x570000_g_MissionName5。\n\t将扣除您的龙眼石x570000_g_NeedNum1颗。"
...
function x570000_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
	if sceneId ==0 then
