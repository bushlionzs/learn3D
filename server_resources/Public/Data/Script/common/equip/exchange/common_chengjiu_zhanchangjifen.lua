...
x570038_g_ExtTarget={}
x570038_g_MissionName1 = "战场积分兑换经验"
--MisDescEnd
...
function x570038_ProcEventEntry( sceneId, selfId, targetId, scriptid, extid)	--点击该任务后执行此脚本
...
function x570038_ProcAccept( sceneId, selfId)
    ...
    if score < 1000 then
        Msg2Player( sceneId, selfId, "你的战场积分不足1000点，无法兑换经验", 8, 3)
        return
    end
