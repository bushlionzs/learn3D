...
x800069_g_ask ={"【装备回收说明】"}
x800069_g_answer ={"#Y【装备回收说明】#W\n\t所有使用声望、荣誉、帮贡和战场积分换购的装备，都可以在我这里回收成相对应的成本。\n#Y操作说明#W：\n\t1.与王国#G装备回收大师#W或大都#G装备回收大师#W对话。\n\t2.选择#G装备回收#W选项。\n\t3.将需要回收的装备放入到装备回收界面中间的格子内。\n\t4.点击界面下方回收按钮。\n#Y注意事项#W：\n\t黄色的装备在我这里只能兑换到70%的成本，而紫色的装备因为材质优异则可以兑换出100%的成本。"}

function x800069_ProcEventEntry(sceneId, selfId, NPCId, MissionId,which)	--点击该任务后执行此脚本
		if which == 0 then
