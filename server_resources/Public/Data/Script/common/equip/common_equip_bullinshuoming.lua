...
x800081_g_MissionName1="【制造符文说明】"
x800081_g_MissionInfo1="\t制造符文可将蓝色装备上的某项蓝色属性附加在符文布或优质符文布上，成为对应装备部件的符文。制造符文消耗蓝色装备、符文布或优质符文布。\n#Y操作说明#W：\n\t1.与王国#G外装大师#W或大都#G外装大师#W对话。\n\t2.选择#G制造符文#W选项。\n\t3.将符文布或优质符文布放入到制造符文界面左上方格子内。\n\t4.将蓝色装备放入到制造符文界面符文布格子下方格子内。\n\t5.点击界面下方制造按钮。\n#Y注意事项#W：\n\t1.符文布、优质符文布会#G随机#W吸收蓝色装备上的一项蓝色属性。\n\t2.#G符文布#W吸取装备蓝色属性#G有几率失败#W。\n\t3.#G优质符文布#W吸取装备蓝色属性#G不会失败#W。\n\t4.制造符文无论成功与否，#G蓝色装备都会消失#W。"  --任务描述
--x800081_g_MissionInfo2="\t#G龙眼石#W是王国加强边防的重要物资。王国大将军派我在这里向所有王国的子民们收集#G龙眼石#W。如果您获得了#G龙眼石#W之后，把它交给我，可以得到珍贵的装备。\n\t龙眼石兑换的装备分为世传，国传，神传，天传四种。世传装备需要#G初级龙眼石#W，国传装备需要#G中级龙眼石#W，神传装备需要#G高级龙眼石#W。天传装备需要#G天之龙眼石#W。\n\t我现在能为您兑换国传装备、神传装备和天传装备！"  --任务描述
--x800081_g_MissionCompleted1=""--完成任务npc说话的话
--x800081_g_MissionCompleted2=""--完成任务npc说话的话
--x800081_g_ContinueInfo1="\t你将要x800081_g_MissionName5。\n\t将扣除您的龙眼石x800081_g_NeedNum1颗。"
...
function x800081_ProcEventEntry(sceneId, selfId, targetId,scriptid,extid)	--点击该任务后执行此脚本
	--检测列出条件
