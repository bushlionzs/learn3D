...
x300767_g_MissionName				= 	"帮会暗战" 
x300767_g_MissionInfo				= 	"巡按任务信息" 
--MisDescEnd

function x300767_ProcEnumEvent( sceneId, selfId, targetId )
end

function x300767_ProcEventEntry(sceneId, selfId,targetId)	--点击该任务后执行此脚本
		BeginQuestEvent(sceneId)
		local Readme_1 = "#Y【帮会暗战说明】#r#W"
		local Readme_2 = "  1.#G接取任务：#W帮会成员每天可以自行接取此任务。#r"
