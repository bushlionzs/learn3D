...
x300926_g_MissionName				= "【帮会】帮会贡品"
x300926_g_MissionInfo				= "任务信息"
x300926_g_MissionTarget				= "  收集@item_%d#W(%d/1)"
x300926_g_MissionDescription        = "\t帮会贡品任务，分为#G寻物#W和#G送信#W两种，您只需要按照帮会任务发布人的要求完成任务，就可以获得#G经验#W和#G帮贡#W的奖励。"
x300926_g_MissionTips               = "如果想要了解本任务的细节，请点击帮会贡品任务说明按钮。"
x300926_g_MissionBook               = "上交指定的物品就能完成此任务，如果没有可以考虑向别的玩家收购。"
--MisDescEnd

x300926_g_strFinishAll              = "你今天不能再领取【帮会】帮会贡品任务了"
x300926_g_strTip                    = "#c00FF00小提示:"
x300926_g_strMissionTip             = "#c00FF00如果想要了解本任务的细节，请点击帮会任务说明按钮。"
x300926_g_strAddMissionFail         = "你接受的任务太多了，添加新任务失败"
x300926_g_strMissionComplete        = "\t太好了，你果然做的干净利索。"
x300926_g_strMissionFinished        = "完成【帮会】帮会贡品(%d/10)"
x300926_g_strCommitItemFail         = "提交物品失败，交任务失败"
x300926_g_strObtainXP               = "获得#R%d#cffcc00点经验。"
x300926_g_strObtainGP               = "获得#R%d#cffcc00点帮贡。"
x300926_g_MissionTarget1			= "  找到@npc_%d\n  找到@npc_%d\n  找到@npc_%d"
x300926_g_MissionContinue			= "\t请尽快完成交给你的事情。"
...
x300926_MP_INDEX5					= 5         -- 
x300926_MP_INDEX6					= 6         -- 
x300926_MP_FINISH                   = 7         -- 玩家接任务时的等级
x300926_MP_ISCOMPLETE				= 0	        -- 代表完成 0未完成， 1完成
-- 交任务NPC的GUID
...
x300926_g_LookforItemTable          = {
                                        { minLevel = 20, maxLevel = 40, 
                                            ...
                                            targets = {
                                                    { npcId = 126126, Dialog = "\t这点小事情也要来找我……\n\t好吧!一会我就带人去看看。"	}, --1
                                                    { npcId = 126135, Dialog = "\t没有问题，我的朋友，很高兴能帮上你们的忙。"	}, --2
                                                    { npcId = 126006, Dialog = "\t这个……最近我已经忙的焦头烂额了。\n\t这样吧，我处理完这事就过去。"	}, --3
                                                    { npcId = 126036, Dialog = "\t我很乐意帮忙~不过，请稍等，小女子梳妆完毕，自会前往。"	}, --4
                                                    { npcId = 126134, Dialog = "\t你们要大采购么？要不要我带上货单？"	}, --5
                                                    { npcId = 126025, Dialog = "\t有什么需要我帮助的吗？好吧，我这就动身。"	}, --6
                                                    { npcId = 126023, Dialog = "\t我会去的……不过，要等我的徒弟回来的时候。"	}, --7
                                                },
                                        }, 
                                        { minLevel = 40, maxLevel = 60, 
                                            ...
                                            targets = {
                                                    { npcId = 126066, Dialog = "\t比力克孜让你来的？好吧，我正想去找他，上次他从我这里订购的货物，到现在帐也没付清！"	}, 
                                                    { npcId = 126076, Dialog = "\t哦，找我么？难道有淘汰下来的装备？！好我这就过去。"	}, 
                                                    { npcId = 126063, Dialog = "\t押运官的职责让我不能轻易离开，不过我可以让那些来押运的家伙帮点小忙……"	}, 
                                                    { npcId = 126031, Dialog = "\t帮忙？有报酬么？一会我派个伙计去看看，没有赚头的生意我从来不做！"	}, 
                                                    { npcId = 126072, Dialog = "\t啊？为什么要来找我？"	}, 
                                                    { npcId = 126074, Dialog = "\t这事情……我要先和我妻子说一下，不过我相信她一定会同意的。"	}, 
                                                    { npcId = 126035, Dialog = "\t好，你们帮的人都是我的老顾客，我一定准时到。"	}, 
                                                },
                                        }, 
                                        { minLevel = 60, maxLevel = 160, 
                                            ...
                                            targets = {
                                                    { npcId = 126029, Dialog = "\t好的好的，等我把手头上这几件装备铭刻了就过去。"	}, 
                                                    { npcId = 126032, Dialog = "\t很高兴能为贵帮帮忙，我准备一下马上就到。"	}, 
                                                    { npcId = 126080, Dialog = "\t需要我的帮助？没问题！我可是出了名的好说话。"	}, 
                                                    { npcId = 126073, Dialog = "\t很高兴能为贵帮进些微薄之力，我准备一下马上就到。"	}, 
                                                    { npcId = 126065, Dialog = "\t我从不问江湖事，不过你们帮主的面子我还是要给的。\n\t好吧，你先回去，我随后就到。"	}, 
                                                    { npcId = 126030, Dialog = "\t有人找帮忙？等我收拾一下，一会就去。"	}
                                                },
                                        }, 
}
-- 经验奖励系数
...
function x300926_ProcQuestLogRefresh( sceneId, selfId, MissionId)
    ...
    if mp2 == 0 then
        AddQuestLogCustomText( sceneId,
                                "",                             -- 标题
                                x300926_g_MissionName..format( "(%d/%d)", x300926_GetMD( sceneId, selfId, MD_BANGHUI_CIRCLE), x300926_g_MaxCircle), -- 任务名字
