...
x430111_g_ItemTable         = {
                                ...
                                { name = "神传龙吟戒指（十字军）", itemid = 10298020 }, 
                                { name = "神传碎玉戒指（圣火使）", itemid = 10298024 }, 
                                { name = "神传逐日戒指（刺客）", itemid = 10298028 }, 
                                { name = "神传虎跃戒指（近卫军）", itemid = 10298032 }, 
                                { name = "神传白虎戒指（隐修士）", itemid = 10298036 }, 
                                { name = "神传师君戒指（僧侣）", itemid = 10298040 }, 
...
function x430111_ProcEventEntry( sceneId, selfId, targetId, scriptid, extid)
    BeginQuestEvent( sceneId)
        AddQuestText( sceneId, format( "\t您确认要选择#Y%s#W吗？\n\t您确认后将永久的获得，请谨慎挑选！", x430111_g_ItemTable[ extid].name) )
