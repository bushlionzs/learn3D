...
function x418033_OnActivateOnce( sceneId, selfId, impactId )
	...
	if nZhiYe == 0 or nZhiYe == 1 or nZhiYe == 6 or nZhiYe == 7 then
		itemId1 = 14010001 --初级红变石*1
	elseif nZhiYe == 2 or nZhiYe == 3 or nZhiYe == 8 or nZhiYe == 9 then
		itemId1 = 14010006 --初级红琥珀*1
	elseif nZhiYe ==4 or nZhiYe == 5 or nZhiYe == 10 or nZhiYe == 11 then
		itemId1 = 14010011 --初级红锆石*1
	end
		
	BeginAddItem(sceneId)
	AddBindItem( sceneId, 11000200, 100 )	--世传水晶（11000200）*100 
	AddBindItem( sceneId, 11050001, 130 )	--初级龙眼石（11050001）*130 
	AddItem( sceneId, 11060001, 20 )	--王国银票（11060001）*20
	AddItem( sceneId, 11000100, 1 )	--赤铜钻（11000100）*1	
	AddItem( sceneId, 11000110, 1 )	--青铜钻（11000110）*1
	AddItem( sceneId, 14040001, 1 )	--初级蓝玛瑙（14040001）*1
	AddItem( sceneId, itemId1, 1 )	--初级攻击宝石*1
