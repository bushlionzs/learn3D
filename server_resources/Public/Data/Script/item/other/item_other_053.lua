...
x418053_g_scriptId = 418053
x418053_g_ItemList = {}
x418053_g_LevelMin = 65	
--需要的等级
...
--事件交互入口
--**********************************
function x418053_ProcEventEntry( sceneId, selfId, bagIndex )
-- 不需要这个接口，但要保留空函数
end
...
--**********************************
function x418053_IsSkillLikeScript( sceneId, selfId)
	return 1; --这个脚本需要动作支持
end
...
--**********************************
function x418053_CancelImpacts( sceneId, selfId )
...
--**********************************
function x418053_OnConditionCheck( sceneId, selfId )
...
--**********************************
function x418053_OnDeplete( sceneId, selfId )
...
--注：这里是技能生效一次的入口
--**********************************
function x418053_OnActivateOnce( sceneId, selfId, impactId )
	
	if GetLevel(sceneId, selfId)< x418053_g_LevelMin then
	...
	AddBindItem( sceneId, 12030210, 1 )	--威望之星1
...
--注：这里是技能生效一次的入口
--**********************************
function x418053_OnActivateEachTick( sceneId, selfId)
