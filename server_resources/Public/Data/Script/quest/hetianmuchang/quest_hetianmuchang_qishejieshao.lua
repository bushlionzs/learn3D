...
--x203617_g_Name	={"穆林","斡鲁斯" }
x203617_g_ExtTarget={{type=20,n=3,target="向@npc_128001讨教职业发展"}}
x203617_g_MissionName="【新手】初识职业"
x203617_g_MissionTalk={"骑射的现状","骑射的特点","如何能成为宗师"}
x203617_g_MissionInfo="\t作为一个初入世界的新人，首先必须要对自己的职业有明确的认识。\n\t我的朋友智者哈达，年轻时游历世界，见多识广。他一定可以为你做出有关你的职业的指点。"  --任务描述
x203617_g_MissionTarget="向@npc_128001讨教职业发展"		
x203617_g_MissionCompleted="\t绝世武功并非朝夕而蹴，只有持之以恒的练习，才能成为一代宗师。"
x203617_g_ContinueInfo={"\t我们是当之无愧的陷阱大师，再勇猛的敌人在我们面前也会无可奈何，“狡兔三窟”形容我们并不为过。",
												"\t箭意味着迅猛锐利的意志，弓象征着我们天生具备不屈的韧性。骑射手驰骋沙场，所向披靡。",
												"\t技能均为远程伤害技能，以单目标攻击技能为主，配有部分多目标技能。\n"}
x203617_g_MissionHelp =	"#G您可以用鼠标#R左键#G点击@npc_128001，和他对话。您可以点击键盘上的#RQ#G键，打开任务列表，选中你要完成的任务，点击#R任务目标#G中的蓝色字体来进行自动寻路。"
...
x203617_g_NpcGUID = {{ guid = 128001, name = "长老哈达"} }
...
function x203617_ProcEventEntry(sceneId, selfId, NPCId, MissionId,which)	--点击该任务后执行此脚本
...
function x203617_Msg2toplayer( sceneId, selfId,type)
		if type == 0 then
				Msg2Player(sceneId, selfId, "您接受了任务"..x203617_g_MissionName.."！", 0, 2)
		  	Msg2Player(sceneId, selfId, "您接受了任务"..x203617_g_MissionName.."！", 0, 3)
		elseif type == 1 then
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203617_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203617_g_MissionName.."！", 0, 3)
		elseif type == 2 then
				Msg2Player(sceneId, selfId, "您完成了任务"..x203617_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您完成了任务"..x203617_g_MissionName.."！", 0, 3)
				if x203617_g_ExpBonus > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G经验"..x203617_g_ExpBonus.."#cffcf00的奖励", 0, 2)
  			end
				if x203617_g_BonusMoney1 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G银卡"..x203617_g_BonusMoney1.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203617_g_BonusMoney2 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G现银"..x203617_g_BonusMoney2.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203617_g_BonusMoney3 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G金卡"..x203617_g_BonusMoney3.."文#cffcf00的奖励", 0, 2)
				end
				if x203617_g_BonusMoney4 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G朝廷声望值"..x203617_g_BonusMoney4.."#cffcf00的奖励", 0, 2)
				end
				if x203617_g_BonusMoney5 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G声望"..x203617_g_BonusMoney5.."#cffcf00的奖励", 0, 2)
				end
				if x203617_g_BonusMoney6 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G荣誉"..x203617_g_BonusMoney6.."#cffcf00的奖励", 0, 2)
				end
		end
end
