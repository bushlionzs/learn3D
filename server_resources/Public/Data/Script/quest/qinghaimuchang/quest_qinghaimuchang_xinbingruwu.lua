...
x203432_g_Name	={}
x203432_g_ExtTarget={{type=20,n=1,target="找到@npc_131025"}}
x203432_g_MissionName="【新手】新兵入伍"
x203432_g_MissionInfo="\t王国的征兵点就在东方，那里一定有很多和你一样想加入军队的年轻人。\n\t你还在等待什么？快骑着你的战马，去那看看吧！"  --任务描述
x203432_g_MissionTarget="找到@npc_131025"		
x203432_g_MissionCompleted="\t又一位想入伍的年轻人？很好！"					--完成任务npc说话的话
...
x203432_g_BonusItem	=	{}
x203432_g_NpcGUID ={{ guid = 131025, name = "征兵校尉"} }
--MisDescEnd
--**********************************
...
function x203432_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
	if IsQuestHaveDone(sceneId, selfId, x203432_g_MissionId) > 0 then
		return 
	end
	if IsHaveQuest(sceneId,selfId, x203432_g_MissionId) > 0 then
...
function x203432_Msg2toplayer( sceneId, selfId,type)
		if type == 0 then
				Msg2Player(sceneId, selfId, "您接受了任务"..x203432_g_MissionName.."！", 0, 2)
		  	Msg2Player(sceneId, selfId, "您接受了任务"..x203432_g_MissionName.."！", 0, 3)
		elseif type == 1 then
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203432_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203432_g_MissionName.."！", 0, 3)
		elseif type == 2 then
				Msg2Player(sceneId, selfId, "您完成了任务"..x203432_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您完成了任务"..x203432_g_MissionName.."！", 0, 3)
				if x203432_g_ExpBonus > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G经验"..x203432_g_ExpBonus.."#cffcf00的奖励", 0, 2)
  			end
				if x203432_g_BonusMoney1 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G银卡"..x203432_g_BonusMoney1.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203432_g_BonusMoney2 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G现银"..x203432_g_BonusMoney2.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203432_g_BonusMoney3 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G金卡"..x203432_g_BonusMoney3.."文#cffcf00的奖励", 0, 2)
				end
				if x203432_g_BonusMoney4 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G朝廷声望值"..x203432_g_BonusMoney4.."#cffcf00的奖励", 0, 2)
				end
				if x203432_g_BonusMoney5 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G声望"..x203432_g_BonusMoney5.."#cffcf00的奖励", 0, 2)
				end
				if x203432_g_BonusMoney6 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G荣誉"..x203432_g_BonusMoney6.."#cffcf00的奖励", 0, 2)
				end
		end
end
