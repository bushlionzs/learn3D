...
x270011_g_Name	={}
x270011_g_ExtTarget={{type=20,n=1,target="到@npc_141011处等待张生把孙飞虎引开后杀了孙飞虎"}}
...
x270011_g_huwei1 = -1
x270011_g_huwei2 = -1
x270011_g_NpcGUID ={{ guid = 140401, name = "崔母"}}
				...
				if x270011_CheckSubmit(sceneId, selfId) <= 0 then
					--if GetName(sceneId,x270011_g_sunfeihu)~="孙飞虎" then
							...
							if x270011_g_PROTECTINFO.ScneneTimerIndex >= 0 then
									x270011_g_doing = 1
									x270011_g_sunfeihu=CreateMonster(sceneId, 1617,155,475,5,1,-1,-1,20,80000,180,"孙飞虎")
									x270011_g_huwei1=CreateMonster(sceneId, 1618,151,477,3,1,-1,-1,20,80000,180,"护卫")
									x270011_g_huwei2=CreateMonster(sceneId, 1618,151,473,3,1,-1,-1,20,80000,180,"护卫")
...
function x270011_OnScneneTimer(sceneId)
	...
	elseif x270011_g_doing==5   then
		if GetCurrentTime() - x270011_g_PROTECTINFO.StartTime >= 14   then
						...
						x270011_g_zhangsheng=CreateMonster(sceneId, 1621,166,458,3,1,-1,-1,20,30000,0,"崔莺莺","张生扮")
		end
