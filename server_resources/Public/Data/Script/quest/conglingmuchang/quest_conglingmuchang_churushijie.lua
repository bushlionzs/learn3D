...
x203500_g_Name	={}
x203500_g_ExtTarget={{type=20,n=1,target="找到@npc_125000"}}
x203500_g_MissionName="【新手】征兵令"
x203500_g_MissionInfo="\t欢迎来到成吉思汗的世界！请耐心阅读一下：#r　#r\t通过您的鼠标#G左键#W点击地面可以#G行走#W，点击游戏中的人物可以和他#G交谈#W。#r\t#W若您看到的NPC头顶有#Y金色的问号#W“#Y？#W”，您可以使用鼠标左键点击他#G完成任务#W。#r　#r\t现在，看到身旁的#G雄鹰长老#W头顶的金色问号“#Y？#W”了吗？他已经等候你许久了，和他谈谈吧。"  --任务描述
x203500_g_MissionTarget=""		
x203500_g_MissionCompleted="\t#Y@myname#W,欢迎你！\n\t随着海都大王叛乱的愈演愈烈，战火已经蔓延到了一向安宁祥和的楼兰王国。\n\t近日，大元皇帝忽必烈陛下下旨，楼兰王国开始征兵！\n\t所有楼兰王国的勇士，都可以加入楼兰军，跃马扬鞭，建功立业！"					--完成任务npc说话的话
x203500_g_ContinueInfo=""
x203500_g_MissionHelp =	"您可以用鼠标#R左键#G点击雄鹰长老，和他对话。您可以点击键盘上的#RQ#G键，打开任务列表，选中你要完成的任务，点击#R任务目标#G中的蓝色字体来进行自动寻路。"
...
function x203500_ProcEventEntry(sceneId, selfId, NPCId, MissionId)	--点击该任务后执行此脚本
	if IsQuestHaveDone(sceneId, selfId, x203500_g_MissionId) > 0 then
		return 
	end
	if IsHaveQuest(sceneId,selfId, x203500_g_MissionId) > 0 then
...
function x203500_Msg2toplayer( sceneId, selfId,type)
		if type == 0 then
				Msg2Player(sceneId, selfId, "您接受了任务"..x203500_g_MissionName.."！", 0, 2)
		  	Msg2Player(sceneId, selfId, "您接受了任务"..x203500_g_MissionName.."！", 0, 3)
		elseif type == 1 then
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203500_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您放弃了任务"..x203500_g_MissionName.."！", 0, 3)
		elseif type == 2 then
				Msg2Player(sceneId, selfId, "您完成了任务"..x203500_g_MissionName.."！", 0, 2)
				Msg2Player(sceneId, selfId, "您完成了任务"..x203500_g_MissionName.."！", 0, 3)
				if x203500_g_ExpBonus > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G经验"..x203500_g_ExpBonus.."#cffcf00的奖励", 0, 2)
  			end
				if x203500_g_BonusMoney1 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G银卡"..x203500_g_BonusMoney1.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203500_g_BonusMoney2 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G现银"..x203500_g_BonusMoney2.."文#cffcf00的奖励", 0, 2)
	  		end
				if x203500_g_BonusMoney3 > 0 then
	  		  Msg2Player(sceneId, selfId, "#cffcf00获得#G金卡"..x203500_g_BonusMoney3.."文#cffcf00的奖励", 0, 2)
				end
				if x203500_g_BonusMoney4 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G朝廷声望值"..x203500_g_BonusMoney4.."#cffcf00的奖励", 0, 2)
				end
				if x203500_g_BonusMoney5 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G声望"..x203500_g_BonusMoney5.."#cffcf00的奖励", 0, 2)
				end
				if x203500_g_BonusMoney6 > 0 then
					Msg2Player(sceneId, selfId, "#cffcf00获得#G荣誉"..x203500_g_BonusMoney6.."#cffcf00的奖励", 0, 2)
				end
		end
end
