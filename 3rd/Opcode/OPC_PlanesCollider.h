...
#define __OPC_PLANESCOLLIDER_H__
	...
	class OPCODE_API PlanesCollider : public VolumeCollider
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							bool			Collide(PlanesCache& cache, const IceMaths::Plane* planes, udword nb_planes, const Model& model, const Matrix4x4* worldm=null);
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		iceoverride(Collider)	const char*		ValidateSettings();
		...
		inline_				BOOL			PlanesTriOverlap(udword in_clip_mask);
			// Init methods
							BOOL			InitQuery(PlanesCache& cache, const IceMaths::Plane* planes, udword nb_planes, const Matrix4x4* worldm=null);
	};
	...
	class OPCODE_API HybridPlanesCollider : public PlanesCollider
	{
		...
		virtual								~HybridPlanesCollider();
							...
							bool			Collide(PlanesCache& cache, const IceMaths::Plane* planes, udword nb_planes, const HybridModel& model, const Matrix4x4* worldm=null);
		protected:
