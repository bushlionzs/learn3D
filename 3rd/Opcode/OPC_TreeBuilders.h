...
#define __OPC_TREEBUILDERS_H__
	...
	class OPCODE_API AABBTreeBuilder
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual	bool	ComputeGlobalBox(const uqword* primitives, udword nb_prims, AABB& global_box)	const	= 0;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual		float	GetSplittingValue(const uqword* primitives, udword nb_prims, const AABB& global_box, udword axis)	const
		{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual	BOOL ValidateSubdivision(const uqword* primitives, udword nb_prims, const AABB& global_box)
		{
	...
	class OPCODE_API AABBTreeOfVerticesBuilder : public AABBTreeBuilder
	{
		...
		iceoverride(AABBTreeBuilder)	bool			ComputeGlobalBox(const uqword* primitives, udword nb_prims, AABB& global_box)	const;
		iceoverride(AABBTreeBuilder)	float			GetSplittingValue(udword index, udword axis)									const;
		iceoverride(AABBTreeBuilder)	float			GetSplittingValue(const uqword* primitives, udword nb_prims, const AABB& global_box, udword axis)	const;
