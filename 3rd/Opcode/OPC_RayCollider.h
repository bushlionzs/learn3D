...
#define __OPC_RAYCOLLIDER_H__
	...
	class OPCODE_API CollisionFaces : private Container
	{
		...
		{ 
			Add((uqword)face.mFaceID).Add(face.mDistance).Add(face.mU).Add(face.mV);	
		}
	};
	...
	class OPCODE_API RayCollider : public Collider
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							bool			Collide(const IceMaths::Ray& world_ray, const Model& model, const Matrix4x4* world=null, udword* cache=null);
		//
		...
		inline_				BOOL			RayTriOverlap(const Point& vert0, const Point& vert1, const Point& vert2);
			// Init methods
							BOOL			InitQuery(const IceMaths::Ray& world_ray, const Matrix4x4* world=null, udword* face_id=null);
	};
