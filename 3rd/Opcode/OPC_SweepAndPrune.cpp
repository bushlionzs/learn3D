 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ void Remap(SAP_Element*& element, uqword delta)
{
	if(element)	element = (SAP_Element*)(uqword(element) + delta);
}
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
SAP_Element* SAP_PairData::GetFreeElem(udword id, SAP_Element* next, uqword* remap)
{
	if(remap)	*remap = 0;
	...
	else
	{
		if(mNbUsedElements==mNbElements)
		{
			...
			// Remap everything
			{
				uqword Delta = uqword(NewElems) - uqword(mElementPool);
