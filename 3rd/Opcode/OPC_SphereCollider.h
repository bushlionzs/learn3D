...
#define __OPC_SPHERECOLLIDER_H__
	...
	class OPCODE_API SphereCollider : public VolumeCollider
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							bool			Collide(SphereCache& cache, const IceMaths::Sphere& sphere, const Model& model, const Matrix4x4* worlds=null, const Matrix4x4* worldm=null);
		...
		inline_				BOOL			SphereAABBOverlap(const Point& center, const Point& extents);
			...
			// Init methods
							BOOL			InitQuery(SphereCache& cache, const IceMaths::Sphere& sphere, const Matrix4x4* worlds=null, const Matrix4x4* worldm=null);
	};
	...
	class OPCODE_API HybridSphereCollider : public SphereCollider
	{
		...
		virtual								~HybridSphereCollider();
							...
							bool			Collide(SphereCache& cache, const IceMaths::Sphere& sphere, const HybridModel& model, const Matrix4x4* worlds=null, const Matrix4x4* worldm=null);
		protected:
