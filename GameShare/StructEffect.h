/*$T Common/StructEffect.h GC 1.140 10/10/07 10:06:56 */
 ...
 */
public:
	enum { IDX_FADE_OUT = 0, IDX_CRITICAL = 1, IDX_CREATE_BY_PLAYER, IDX_MAX, };
...
enum _IMPACT_BUFF_VISABLE_TYPE { IMPACT_BUFF_VISABLE_INVALID, IMPACT_BUFF_VISABLE_CAN, IMPACT_BUFF_VISABLE_CANNOT, };

class _OWN_EFFECT :
	public _OWN_EFFECT_DB
{
/*
 -----------------------------------------------------------------------------------------------------------------------
 -----------------------------------------------------------------------------------------------------------------------
...
typedef class _OWN_EFFECT	UNIT_EFFECT;

enum _IMPACT_CALL_SCRIPT_TYPE { IMPACT_CALL_SCRIPT_ADD = 0, IMPACT_CALL_SCRIPT_DEL };
#endif
