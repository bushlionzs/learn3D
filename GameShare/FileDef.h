...
#define FILE_TIMER_BATTLE_LIST				"./Config/GuildBattleTimer.tab"
#define FILE_SCENE_COMMON					"./Config/map_common.tab"
...
#define FILE_SCENE_ANSWERS_INFO				"./Config/SceneAnswers.tab"
#define FILE_MASTER_PRENTICE_TABLE_NAME		"./Config/master_prentice.tab"
#define FILE_FUBEN_DATA_TABLE_NAME			"./Config/FubenData.tab"
...
#define FILE_PK_POINT						"./Config/PK_Point.tab"
#define FILE_PK_LEVEL						"./Config/PK_Level.tab"
#define FILE_PK_PUNISH						"./Config/PK_Punish.tab"
...
#define FILE_QUEST_QUIZ_INFO				"./Config/quest_quiz.tab"
#define FILE_QUEST_SHITU_INFO				"./Config/quest_shitu.tab"
