/*$T Common/EncryptAriths/Mars.cpp GC 1.140 10/10/07 10:06:29 */
...
static uint32 gen_mask(uint32 x)
{
	/*~~~~~~*/
	uint32	m;
	/*~~~~~~*/
...
void MARS::SetUserKey(const byte *userKey)
{
	m_BlockLen = KEYLENGTH;

	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	const uint32		c = (KEYLENGTH - 1) / 4 + 1;
	SecBlock<uint32, c>	k;
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	...
	for(i = (KEYLENGTH - 1); i >= 0; i--) k[i / 4] = (k[i / 4] << 8) + userKey[i];

	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	SecBlock<uint32, 47>	VK;
	uint32			j, m, u, w, *t = VK + 7;
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

	for(i = 0; i < 7; i++) t[i - 7] = Sbox[i];
...
/*
 ...
 =======================================================================================================================
 */
void MARSEncryption::SetUserKey(const byte *userKey)
{
	MARS::SetUserKey(userKey);
}
...
/*
 ...
 =======================================================================================================================
 */
void MARSDecryption::SetUserKey(const byte *userKey)
{
	MARS::SetUserKey(userKey);
}
