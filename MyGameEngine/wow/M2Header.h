...
struct ModelParticleParams {
	...
	float unknown2[2];
	Ogre::Vector3 Rot1;					//Model Rotation 1
	Ogre::Vector3 Rot2;					//Model Rotation 2
	Ogre::Vector3 Trans;				//Model Translation
	float f2[4];
...
struct ModelParticleEmitterDef {
	...
	Ogre::Vector3 pos; // The position. Relative to the following bone.
