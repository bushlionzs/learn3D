...
-----------------------------------------------------------------------------
*/
#ifndef __PolarEmitterFactory_H__
#define __PolarEmitterFactory_H__
...
namespace Ogre {
    ...
    */
    class  PolarEmitterFactory : public ParticleEmitterFactory
    {
    ...
    public:
        ...
        {
            ParticleEmitter* emit = OGRE_NEW PolarEmitter(psys);
