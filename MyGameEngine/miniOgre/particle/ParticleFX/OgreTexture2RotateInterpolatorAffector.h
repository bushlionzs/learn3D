...
#ifndef __Texture2RotateInterpolatorAffector_H__
#define __Texture2RotateInterpolatorAffector_H__
...
namespace Ogre 
{
    class  Texture2RotateInterpolatorAffector : public ParticleAffector
    {
    public:

		enum { MAX_STAGES = 6 };

        class CmdTextureRotateAdjust : public ParamCommand
        {
		public:
			size_t		mIndex;
        ...
        /** Default constructor. */
        Texture2RotateInterpolatorAffector(ParticleSystem* psys);

        /** See ParticleAffector. */
        void _affectParticles(ParticleSystem* pSystem, Real timeElapsed);

		void setRotateAdjust(size_t index, float rotate);
		float getRotateAdjust(size_t index) const;
		...
		static CmdTextureRotateAdjust	msTextureRotateCmd[MAX_STAGES];
        static CmdTimeAdjust	msTimeCmd[MAX_STAGES];

    protected:

		Real					mTextureRotate[MAX_STAGES];
