#ifndef OgreNoiseColorAffector_h__
#define OgreNoiseColorAffector_h__
...
namespace Ogre
{
	class   NoiseColorAffector : public ParticleAffector
	{
	public:
		...
		NoiseColorAffector(ParticleSystem* particleSystem);
...
#endif // OgreNoiseColorAffector_h__