...
#ifndef __Texture1RotateInterpolatorAffector_H__
#define __Texture1RotateInterpolatorAffector_H__
...
namespace Ogre 
{
    class  Texture1RotateInterpolatorAffector : public ParticleAffector
    {
    public:
        ...
        /** Default constructor. */
        Texture1RotateInterpolatorAffector(ParticleSystem* psys);
		...
		static CmdTexturePosAdjust	msTextureRotateCmd[MAX_STAGES];
        static CmdTimeAdjust	msTimeCmd[MAX_STAGES];

    protected:

		float					mTextureRotate[MAX_STAGES];
